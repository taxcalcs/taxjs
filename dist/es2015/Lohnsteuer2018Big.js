...
export class Lohnsteuer2018Big {
    ...
    MZTABFB() {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7428))).round(0, Big.roundDown);
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3714))).round(0, Big.roundDown);
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
        ...
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(13997)) == -1) {
                ...
                if (this.X.cmp(new Big(54950)) == -1) {
                    this.Y = (this.X.sub(new Big(13996))).div(this.ZAHL10000).round(6, Big.roundDown);
                    this.RW = this.Y.mul(new Big(220.13));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(948.49))).round(0, Big.roundDown);
                }
                else {
                    if (this.X.cmp(new Big(260533)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8621.75))).round(0, Big.roundDown);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16437.7))).round(0, Big.roundDown);
                    }
                }
            }
        }

...
*
*/
export class Lohnsteuer2022Big {
    constructor() {
        this.Z_0 = new Big(0);
        this.Z_1 = new Big(1);
    ...
    UPTAB22() {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14927)) == -1) { /**  Geändert für 2022  */
                ...
                this.RW = this.Y.mul(new Big(1008.7)); /**  Geändert für 2022  */
                ...
                if (this.X.cmp(new Big(58597)) == -1) { /**  Geändert für 2022  */
                    ...
                    this.ST = (this.RW.add(new Big(938.24))).round(0, 0 /* RoundDown */); /**  Geändert für 2022  */
                }
                else {
                    if (this.X.cmp(new Big(277826)) == -1) { /**  Geändert für 2022  */
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(9267.53))).round(0, 0 /* RoundDown */); /**  Geändert für 2022  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(17602.28))).round(0, 0 /* RoundDown */); /**  Geändert für 2022  */
                    }
                }
            }
        }
     ...
     */
    toType(name, value) {
        const info = Lohnsteuer2022Big.typeDirectory[name];
        if (!info) {
            throw new Error("Unknown parameter " + name);
        }

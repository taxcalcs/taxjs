        ...
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14927)) == -1) { /**  Geändert für 2022  */
                ...
                if (this.X.cmp(new Big(58597)) == -1) { /**  Geändert für 2022  */
                    ...
                    this.ST = (this.RW.add(new Big(938.24))).round(0, Big.roundDown); /**  Geändert für 2022  */
                }
                else {
                    if (this.X.cmp(new Big(277826)) == -1) { /**  Geändert für 2022  */
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(9267.53))).round(0, Big.roundDown); /**  Geändert für 2022  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(17602.28))).round(0, Big.roundDown); /**  Geändert für 2022  */
                    }
                }
            }
        }

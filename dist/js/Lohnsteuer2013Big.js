...
var Lohnsteuer2013Big = /** @class */ (function () {
    function Lohnsteuer2013Big() {
        ...
        /**  Neuer Wert  2013  */
        this.RENTBEMESSUNGSGR_OST_2013 = new Big(58800);
        /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
        /**  Neuer Wert 2013  */
        this.RENTBEMESSUNGSGR_WEST = new Big(69600);
    }
    ...
    Lohnsteuer2013Big.prototype.UPEVP = function () {
        if (this.KRV > 1) {
            ...
            /**  Neuer Wert 2013  */
            this.VSP1 = (this.ZRE4VP.mul(new Big(0.52))).round(2, Big.roundDown);
    ...
    Lohnsteuer2013Big.prototype.MVSP = function () {
        /**  Neuer Wert 2013  */
        if (this.ZRE4VP.cmp(new Big(47250)) == 1) {
            /**  Neuer Wert 2013  */
            this.ZRE4VP = new Big(47250);
        }
        if (this.PKV > 0) {
            if (this.STKL == 6) {
                this.VSP3 = this.Z_0;
    ...
    Lohnsteuer2013Big.prototype.MST5_6 = function () {
        ...
        if (this.ZZX.cmp(new Big(26441)) == 1) {
            ...
            this.ZX = this.ZZX;
            this.UP5_6();
            if (this.ZZX.cmp(new Big(9550)) == 1) {
                this.VERGL = this.ST;
                this.ZX = new Big(9550);
                this.UP5_6();
                this.HOCH = (this.ST.add((this.ZZX.sub(new Big(9550))).mul(new Big(0.42)))).round(0, Big.roundDown);
    ...
    Lohnsteuer2013Big.prototype.UPTAB13 = function () {
        if (this.X.cmp(new Big(8131)) == -1) {
            this.ST = this.Z_0;
        }
        else {
            if (this.X.cmp(new Big(13470)) == -1) {
                this.Y = (this.X.sub(new Big(8130))).div(new Big(10000)).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(933.7));
                ...
                if (this.X.cmp(new Big(52882)) == -1) {
                    ...
                    this.ST = (this.RW.add(new Big(1014))).round(0, Big.roundDown);
                }
                else {
                    if (this.X.cmp(new Big(250731)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8196))).round(0, Big.roundDown);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(15718))).round(0, Big.roundDown);
                    }
                }
            }
        }

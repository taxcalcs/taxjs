...
var Lohnsteuer2021Big = /** @class */ (function () {
    ...
    Lohnsteuer2021Big.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(85200); /**  Geändert für 2021  */
            }
            else {
                this.BBGRV = new Big(80400); /**  Geändert für 2021  */
            }
            this.RVSATZAN = new Big(0.093); /**  Neu 2019  */
            this.TBSVORV = new Big(0.84); /**  Geändert für 2021 */
        }
        else {
            /**  Nichts zu tun  */
        }
        ...
        this.W1STKL5 = new Big(11237);
        this.W2STKL5 = new Big(28959);
        this.W3STKL5 = new Big(219690);
        this.GFB = new Big(9744);
    ...
    Lohnsteuer2021Big.prototype.UPTAB21 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14754)) == -1) { /**  Geändert für 2021  */
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                this.RW = this.Y.mul(new Big(995.21)); /**  Geändert für 2021  */
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, 0 /* RoundDown */);
            }
            else {
                if (this.X.cmp(new Big(57919)) == -1) { /**  Geändert für 2021  */
                    this.Y = (this.X.sub(new Big(14753))).div(this.ZAHL10000).round(6, 0 /* RoundDown */); /**  Geändert für 2021   */
                    this.RW = this.Y.mul(new Big(208.85)); /**  Geändert für 2021  */
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(950.96))).round(0, 0 /* RoundDown */); /**  Geändert für 2021  */
                }
                else {
                    if (this.X.cmp(new Big(274613)) == -1) { /**  Geändert für 2021  */
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(9136.63))).round(0, 0 /* RoundDown */); /**  Geändert für 2021  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(17374.99))).round(0, 0 /* RoundDown */); /**  Geändert für 2021  */
                    }
                }
            }
        }
    ...
    Lohnsteuer2021Big.prototype.isBigInput = function (name, value) {
     ...
     */
    Lohnsteuer2021Big.prototype.set = function (name, value) {
     ...
     */
    Lohnsteuer2021Big.prototype.get = function (name) {
        if (this.hasOwnProperty(name)) {
            return this[name];
        }
        throw new Error("Unknown parameter " + name);
     ...
     */
    Lohnsteuer2021Big.prototype.getDirectory = function () {
        return Lohnsteuer2021Big.typeDirectory;
    };
    /**
     ...
     */
    Lohnsteuer2021Big.prototype.toType = function (name, value) {
        var info = Lohnsteuer2021Big.typeDirectory[name];
        if (!info) {
            throw new Error("Unknown parameter " + name);
        }
    ...
    Lohnsteuer2021Big._n = "number";
    Lohnsteuer2021Big._b = "Big";
    Lohnsteuer2021Big._i = "input";
    Lohnsteuer2021Big._o = "output";
    Lohnsteuer2021Big._s = "STANDARD";
    Lohnsteuer2021Big._d = "DBA";
    Lohnsteuer2021Big.typeDirectory = {
        "af": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "AJAHR": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "ALTER1": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "ENTSCH": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "f": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "JFREIB": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "JHINZU": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "JRE4": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "JVBEZ": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "KRV": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "KVZ": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "LZZ": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "LZZFREIB": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "LZZHINZU": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "PKPV": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "PKV": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "PVS": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "PVZ": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "R": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "RE4": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "SONSTB": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "STERBE": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "STKL": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "VBEZ": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "VBEZM": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "VBEZS": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "VBS": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "VJAHR": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "VKAPA": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "VMT": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "ZKF": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "ZMVB": { type: Lohnsteuer2021Big._n, direction: Lohnsteuer2021Big._i }, "JRE4ENT": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "SONSTENT": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._i }, "BK": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "BKS": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "BKV": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "LSTLZZ": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "SOLZLZZ": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "SOLZS": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "SOLZV": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "STS": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "STV": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "VKVLZZ": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "VKVSONST": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._s }, "VFRB": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._d }, "VFRBS1": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._d }, "VFRBS2": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._d }, "WVFRB": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._d }, "WVFRBO": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._d }, "WVFRBM": { type: Lohnsteuer2021Big._b, direction: Lohnsteuer2021Big._o, group: Lohnsteuer2021Big._d },
    };

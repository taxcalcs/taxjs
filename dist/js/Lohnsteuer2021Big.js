        ...
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14754)) == -1) { /**  Geändert für 2021  */
                ...
                if (this.X.cmp(new Big(57919)) == -1) { /**  Geändert für 2021  */
                    this.Y = (this.X.sub(new Big(14753))).div(this.ZAHL10000).round(6, Big.roundDown); /**  Geändert für 2021   */
                    this.RW = this.Y.mul(new Big(208.85)); /**  Geändert für 2021  */
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(950.96))).round(0, Big.roundDown); /**  Geändert für 2021  */
                }
                else {
                    if (this.X.cmp(new Big(274613)) == -1) { /**  Geändert für 2021  */
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(9136.63))).round(0, Big.roundDown); /**  Geändert für 2021  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(17374.99))).round(0, Big.roundDown); /**  Geändert für 2021  */
                    }
                }
            }
        }

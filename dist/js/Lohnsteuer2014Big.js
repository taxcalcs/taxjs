...
var Lohnsteuer2014Big = /** @class */ (function () {
    function Lohnsteuer2014Big() {
        ...
        /**  Neuer Wert  2014  */
        this.RENTBEMESSUNGSGR_OST = new Big(60000);
        /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
        /**  Neuer Wert 2014  */
        this.RENTBEMESSUNGSGR_WEST = new Big(71400);
    }
    ...
    Lohnsteuer2014Big.prototype.UPEVP = function () {
        if (this.KRV > 1) {
            ...
            /**  Neuer Wert 2014  */
            this.VSP1 = (this.ZRE4VP.mul(new Big(0.56))).round(2, Big.roundDown);
            this.VSP1 = (this.VSP1.mul(new Big(0.0945))).round(2, Big.roundDown);
        }
    ...
    Lohnsteuer2014Big.prototype.MVSP = function () {
        /**  Neuer Wert 2014  */
        if (this.ZRE4VP.cmp(new Big(48600)) == 1) {
            /**  Neuer Wert 2014  */
            this.ZRE4VP = new Big(48600);
        }
        if (this.PKV > 0) {
            if (this.STKL == 6) {
                this.VSP3 = this.Z_0;
                ...
                if (this.PKV == 2) {
                    ...
                    if (this.PVS == 1) {
                        this.PVSATZAG = new Big(0.00525).round(5);
                    }
                    else {
                        this.PVSATZAG = new Big(0.01025).round(5);
                    }
            ...
            if (this.PVS == 1) {
                this.PVSATZAN = new Big(0.01525).round(5);
            }
            else {
                this.PVSATZAN = new Big(0.01025).round(5);
            }
            if (this.PVZ == 1) {
    ...
    Lohnsteuer2014Big.prototype.MST5_6 = function () {
        ...
        if (this.ZZX.cmp(new Big(26441)) == 1) {
            ...
            this.ZX = this.ZZX;
            this.UP5_6();
            if (this.ZZX.cmp(new Big(9763)) == 1) { /**  Neuer Wert 2014  */
                this.VERGL = this.ST;
                this.ZX = new Big(9763); /**  Neuer Wert 2014  */
                this.UP5_6();
    ...
    Lohnsteuer2014Big.prototype.UPTAB14 = function () {
        if (this.X.cmp(new Big(8355)) == -1) { /**  Neuer Wert 2014  */
            this.ST = this.Z_0;
        }
        else {
            if (this.X.cmp(new Big(13470)) == -1) {
                this.Y = (this.X.sub(new Big(8354))).div(new Big(10000)).round(6, Big.roundDown); /**  Neuer Wert 2014  */
                this.RW = this.Y.mul(new Big(974.58)); /**  Neuer Wert 2014  */
                ...
                if (this.X.cmp(new Big(52882)) == -1) {
                    ...
                    this.ST = (this.RW.add(new Big(971))).round(0, Big.roundDown); /**  Neuer Wert 2014  */
                }
                else {

...
var Lohnsteuer2014Big = /** @class */ (function () {
    ...
    Lohnsteuer2014Big.prototype.UPEVP = function () {
        if (this.KRV > 1) {
            ...
            /**  Neuer Wert 2014  */
            this.VSP1 = (this.ZRE4VP.mul(new Big(0.56))).round(2, 0 /* RoundDown */);
            this.VSP1 = (this.VSP1.mul(new Big(0.0945))).round(2, 0 /* RoundDown */);
        }
    ...
    Lohnsteuer2014Big.prototype.UPTAB14 = function () {
        if (this.X.cmp(new Big(8355)) == -1) { /**  Neuer Wert 2014  */
            ...
            if (this.X.cmp(new Big(13470)) == -1) {
                this.Y = (this.X.sub(new Big(8354))).div(new Big(10000)).round(6, 0 /* RoundDown */); /**  Neuer Wert 2014  */
                ...
                if (this.X.cmp(new Big(52882)) == -1) {
                    ...
                    this.ST = (this.RW.add(new Big(971))).round(0, 0 /* RoundDown */); /**  Neuer Wert 2014  */
                }
                else {

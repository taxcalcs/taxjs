...
var Lohnsteuer2010Big = /** @class */ (function () {
    ...
    Lohnsteuer2010Big.prototype.UPEVP = function () {
        if (this.KRV > 1) {
            ...
            if (this.KRV == 0) {
                ...
                if (this.ZRE4VP.cmp(new Big(55800)) == 1) {
                    this.ZRE4VP = new Big(55800);
                }
            }
            this.VSP1 = (this.ZRE4VP.mul(new Big(0.4))).round(2, 0 /* RoundDown */);
    ...
    Lohnsteuer2010Big.prototype.MVSP = function () {
        if (this.ZRE4VP.cmp(new Big(45000)) == 1) {
            this.ZRE4VP = new Big(45000);
        }
        if (this.PKV > 0) {
            if (this.STKL == 6) {
                this.VSP = this.Z_0;
                ...
                if (this.PKV == 2) {
                    this.KVSATZAG = new Big(0.067).round(5);
                    if (this.PVS == 1) {
            ...
            this.KVSATZAN = new Big(0.076).round(5);
            if (this.PVS == 1) {

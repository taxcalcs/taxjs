...
var Lohnsteuer2016Big = /** @class */ (function () {
    ...
    Lohnsteuer2016Big.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(74400); /**  Neu 2016  */
            }
            else {
                this.BBGRV = new Big(64800); /**  Neu 2016  */
            }
            this.RVSATZAN = new Big(0.0935);
            this.TBSVORV = new Big(0.64); /**  Neu 2016  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this.BBGKVPV = new Big(50850); /**  Neu 2016  */
        this.KVSATZAN = (this.KVZ.div(this.ZAHL100)).add(new Big(0.07));
        this.KVSATZAG = new Big(0.07);
        if (this.PVS == 1) {
            this.PVSATZAN = new Big(0.01675);
            this.PVSATZAG = new Big(0.00675);
        }
        else {
            this.PVSATZAN = new Big(0.01175);
            this.PVSATZAG = new Big(0.01175);
        }
        if (this.PVZ == 1) {
            this.PVSATZAN = this.PVSATZAN.add(new Big(0.0025));
        }
        /**  Anfang Neu 2016  */
        this.W1STKL5 = new Big(10070);
        this.W2STKL5 = new Big(26832);
        this.W3STKL5 = new Big(203557);
        this.GFB = new Big(8652);
    ...
    Lohnsteuer2016Big.prototype.MBERECH = function () {
        ...
        this.VFRB = ((this.ANP.add(this.FVB.add(this.FVBZ))).mul(this.ZAHL100)).round(0, Big.roundDown); /**  Neu 2016  */
        this.MLSTJAHR();
        /**  Anfang Neu 2016  */
    ...
    Lohnsteuer2016Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7248))).round(0, Big.roundDown); /**  Neu 2016  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3624))).round(0, Big.roundDown); /**  Neu 2016  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    Lohnsteuer2016Big.prototype.MSOLZ = function () {
        this.SOLZFREI = (this.SOLZFREI.mul(new Big(this.KZTAB))); /**  Neu 2016  */
    ...
    Lohnsteuer2016Big.prototype.UPTAB16 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(13670)) == -1) {
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(993.62));
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, Big.roundDown);
            }
            else {
                if (this.X.cmp(new Big(53666)) == -1) {
                    this.Y = (this.X.sub(new Big(13669))).div(this.ZAHL10000).round(6, Big.roundDown);
                    this.RW = this.Y.mul(new Big(225.40));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(952.48))).round(0, Big.roundDown);
                }
                else {
                    if (this.X.cmp(new Big(254447)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8394.14))).round(0, Big.roundDown);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16027.52))).round(0, Big.roundDown);
                    }
                }
            }
        }

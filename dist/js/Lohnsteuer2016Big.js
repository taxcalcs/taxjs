...
var Lohnsteuer2016Big = /** @class */ (function () {
    ...
    Lohnsteuer2016Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7248))).round(0, 0 /* RoundDown */); /**  Neu 2016  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3624))).round(0, 0 /* RoundDown */); /**  Neu 2016  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
        ...
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(13670)) == -1) {
                ...
                if (this.X.cmp(new Big(53666)) == -1) {
                    this.Y = (this.X.sub(new Big(13669))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                    this.RW = this.Y.mul(new Big(225.40));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(952.48))).round(0, 0 /* RoundDown */);
                }
                else {
                    if (this.X.cmp(new Big(254447)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8394.14))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16027.52))).round(0, 0 /* RoundDown */);
                    }
                }
            }
        }

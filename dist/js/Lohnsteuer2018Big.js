...
var Lohnsteuer2018Big = /** @class */ (function () {
    ...
    Lohnsteuer2018Big.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(78000); /**  Neu 2018  */
            }
            else {
                this.BBGRV = new Big(69600); /**  Neu 2018  */
            }
            this.RVSATZAN = new Big(0.093); /**  Neu 2018  */
            this.TBSVORV = new Big(0.72); /**  Neu 2018  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this.BBGKVPV = new Big(53100); /**  Neu 2018  */
        this.KVSATZAN = (this.KVZ.div(this.ZAHL100)).add(new Big(0.07));
        this.KVSATZAG = new Big(0.07);
        if (this.PVS == 1) {
            this.PVSATZAN = new Big(0.01775);
            this.PVSATZAG = new Big(0.00775);
        }
        else {
            this.PVSATZAN = new Big(0.01275);
            this.PVSATZAG = new Big(0.01275);
        }
        if (this.PVZ == 1) {
            this.PVSATZAN = this.PVSATZAN.add(new Big(0.0025));
        }
        /**  Anfang Neu 2018  */
        this.W1STKL5 = new Big(10440);
        this.W2STKL5 = new Big(27475);
        this.W3STKL5 = new Big(208426);
        this.GFB = new Big(9000);
        /**  Ende Neu 2018  */
    ...
    Lohnsteuer2018Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7428))).round(0, 0 /* RoundDown */);
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3714))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    Lohnsteuer2018Big.prototype.MST5_6 = function () {
        ...
        if (this.ZZX.cmp(this.W2STKL5) == 1) {
            ...
            if (this.ZZX.cmp(this.W1STKL5) == 1) {
                ...
                this.UP5_6();
                this.HOCH = (this.ST.add((this.ZZX.sub(this.W1STKL5)).mul(new Big(0.42)))).round(0, 0 /* RoundDown */);
    ...
    Lohnsteuer2018Big.prototype.UPTAB18 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(13997)) == -1) {
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                this.RW = this.Y.mul(new Big(997.8));
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, 0 /* RoundDown */);
            }
            else {
                if (this.X.cmp(new Big(54950)) == -1) {
                    this.Y = (this.X.sub(new Big(13996))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                    this.RW = this.Y.mul(new Big(220.13));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(948.49))).round(0, 0 /* RoundDown */);
                }
                else {
                    if (this.X.cmp(new Big(260533)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8621.75))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16437.7))).round(0, 0 /* RoundDown */);
                    }
                }
            }
        }
     ...
     */
    Lohnsteuer2018Big.prototype.setBig = function (name, value) {
     ...
     */
    Lohnsteuer2018Big.prototype.setNumber = function (name, value) {
        if (this.hasOwnProperty(name)) {
            this[name] = value;
        }
        else {

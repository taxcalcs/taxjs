...
*
*/
var Lohnsteuer2022MaiBig = /** @class */ (function () {
    function Lohnsteuer2022MaiBig() {
        this.Z_0 = new Big(0);
        this.Z_1 = new Big(1);
    ...
    Lohnsteuer2022MaiBig.prototype.calculate = function () {
        this.MPARA();
        this.MRE4JL();
        this.VBEZBSO = this.Z_0;
        this.KENNVMT = 0;
    ...
    Lohnsteuer2022MaiBig.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(84600); /**  Geändert für 2022  */
            }
            else {
                this.BBGRV = new Big(81000); /**  Geändert für 2022  */
            }
            this.RVSATZAN = new Big(0.093); /**  Neu 2019  */
            this.TBSVORV = new Big(0.88); /**  Geändert für 2022 */
        }
        else {
            /**  Nichts zu tun  */
        }
        this.BBGKVPV = new Big(58050); /**  Geändert für 2021  */
        this.bd = new Big(2); /**  Neu 2019  */
        this.KVSATZAN = (this.KVZ.div(this.bd).div(this.ZAHL100)).add(new Big(0.07)); /**  Neu 2019  */
        this.KVSATZAG = new Big(0.0065 + 0.07); /**  Geändert für 2021 */
        if (this.PVS == 1) {
        ...
        if (this.PVZ == 1) {
            this.PVSATZAN = this.PVSATZAN.add(new Big(0.0035)); /**   geändert für 2022  */
        }
        /**  Anfang Geändert für 2022  */
        this.W1STKL5 = new Big(11793); /**  2022.2  */
        this.W2STKL5 = new Big(29298);
        this.W3STKL5 = new Big(222260);
        this.GFB = new Big(10347); /**  2022.2  */
    ...
    Lohnsteuer2022MaiBig.prototype.MRE4JL = function () {
        if (this.LZZ == 1) {
    ...
    Lohnsteuer2022MaiBig.prototype.MRE4 = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.MRE4ALTE = function () {
        if (this.ALTER1 == 0) {
            this.ALTE = this.Z_0;
        }
        else {
    ...
    Lohnsteuer2022MaiBig.prototype.MRE4ABZ = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.MBERECH = function () {
        this.MZTABFB();
    ...
    Lohnsteuer2022MaiBig.prototype.MZTABFB = function () {
        this.ANP = this.Z_0;
        ...
        if (this.STKL < 6) {
            if (this.ZRE4.cmp(this.ZVBEZ) == 1) {
                if (this.ZRE4.sub(this.ZVBEZ).cmp(new Big(1200)) == -1) {
                    this.ANP = this.ANP.add(this.ZRE4).sub(this.ZVBEZ).round(0, 3 /* RoundUp */);
                }
                else {
                    this.ANP = this.ANP.add(new Big(1200));
                }
            }
        }
        this.KZTAB = 1;
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(8388))).round(0, 0 /* RoundDown */); /**  Geändert für 2021  */
        }
        else {
            if (this.STKL == 2) {
                this.EFA = new Big(4008); /**  mod f 2022  */
                this.SAP = new Big(36);
                this.KFB = (this.ZKF.mul(new Big(8388))).round(0, 0 /* RoundDown */); /**  Geändert für 2021  */
            }
            else {
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(4194))).round(0, 0 /* RoundDown */); /**  Geändert für 2021  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    Lohnsteuer2022MaiBig.prototype.MLSTJAHR = function () {
        this.UPEVP();
        if (this.KENNVMT != 1) {
    ...
    /**  PAP Seite 24  */
    Lohnsteuer2022MaiBig.prototype.UPVKVLZZ = function () {
        this.UPVKV();
        this.JW = this.VKV;
        this.UPANTEIL();
    ...
    /**  PAP Seite 24  */
    Lohnsteuer2022MaiBig.prototype.UPVKV = function () {
        if (this.PKV > 0) {
    ...
    /**  PAP Seite 25  */
    Lohnsteuer2022MaiBig.prototype.UPLSTLZZ = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.UPMLST = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.UPEVP = function () {
        if (this.KRV > 1) { /**  &lt; = < &gt; = >  */
            this.VSP1 = this.Z_0;
        }
        else {
    ...
    Lohnsteuer2022MaiBig.prototype.MVSP = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.MST5_6 = function () {
        this.ZZX = this.X;
    ...
    Lohnsteuer2022MaiBig.prototype.UP5_6 = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.MSOLZ = function () {
        ...
        if (this.JBMG.cmp(this.SOLZFREI) == 1) {
            ...
            this.SOLZMIN = (this.JBMG.sub(this.SOLZFREI)).mul(new Big(11.9)).div(this.ZAHL100).round(2, 0 /* RoundDown */); /**  Änderung für 2021  */
    ...
    Lohnsteuer2022MaiBig.prototype.UPANTEIL = function () {
        if (this.LZZ == 1) {
    ...
    Lohnsteuer2022MaiBig.prototype.MSONST = function () {
        this.LZZ = 1;
        if (this.ZMVB == 0) {
            this.ZMVB = 12;
        }
    ...
    /**  Neu für 2022  */
    Lohnsteuer2022MaiBig.prototype.STSMIN = function () {
        if (this.STS.cmp(this.Z_0) == -1) { /**  STS < 0  */
            if (this.MBV.cmp(this.Z_0) == 0) { /**   MBV = 0   */
                ...
                this.SOLZLZZ = this.SOLZLZZ.add(this.STS.mul(new Big(5.5).div(this.ZAHL100))).round(0, 0 /* RoundDown */);
    ...
    Lohnsteuer2022MaiBig.prototype.MSOLZSTS = function () {
        if (this.ZKF.cmp(this.Z_0) == 1) { /**  ZKF > 0  */
        ...
        if (this.SOLZSZVE.cmp(this.ZAHL1) == -1) { /**  SOLZSZVE < 1  */
            ...
            this.X = this.SOLZSZVE.div(new Big(this.KZTAB)).round(0, 0 /* RoundDown */);
        }
        ...
        this.SOLZSBMG = this.ST.mul(new Big(this.f)).round(0, 0 /* RoundDown */);
    ...
    Lohnsteuer2022MaiBig.prototype.MVMT = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.MOSONST = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.MRE4SONST = function () {
        this.MRE4();
        this.FVB = this.FVBSO;
        this.MRE4ABZ();
        /**  Änderung für 2022   */
    ...
    Lohnsteuer2022MaiBig.prototype.UPTAB22 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            this.ST = this.Z_0;
        }
        else {
            if (this.X.cmp(new Big(14927)) == -1) { /**  Geändert für 2022  */
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                this.RW = this.Y.mul(new Big(1088.67)); /**  Geändert für 2022.2  */
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, 0 /* RoundDown */);
            }
            else {
                if (this.X.cmp(new Big(58597)) == -1) { /**  Geändert für 2022  */
                    this.Y = (this.X.sub(new Big(14926))).div(this.ZAHL10000).round(6, 0 /* RoundDown */); /**  Geändert für 2022   */
                    this.RW = this.Y.mul(new Big(206.43)); /**  Geändert für 2022  */
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(869.32))).round(0, 0 /* RoundDown */); /**  Geändert für 2022.2  */
                }
                else {
                    if (this.X.cmp(new Big(277826)) == -1) { /**  Geändert für 2022  */
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(9336.45))).round(0, 0 /* RoundDown */); /**  Geändert für 2022.2  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(17671.2))).round(0, 0 /* RoundDown */); /**  Geändert für 2022.2  */
                    }
                }
            }
        }
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getAf = function () {
        return this.af;
    };
    /**
     * Setter for af.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setAf = function (af) {
        this.af = af;
    };
    /**
     * Getter for AJAHR.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getAJAHR = function () {
        return this.AJAHR;
    };
    /**
     * Setter for AJAHR.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setAJAHR = function (AJAHR) {
        this.AJAHR = AJAHR;
    };
    /**
     * Getter for ALTER1.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getALTER1 = function () {
        return this.ALTER1;
    };
    /**
     * Setter for ALTER1.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setALTER1 = function (ALTER1) {
        this.ALTER1 = ALTER1;
    };
    /**
     * Getter for ENTSCH.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getENTSCH = function () {
        return this.ENTSCH;
    };
    /**
     * Setter for ENTSCH.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setENTSCH = function (ENTSCH) {
        this.ENTSCH = ENTSCH;
    };
    /**
     * Getter for f.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getF = function () {
        return this.f;
    };
    /**
     * Setter for f.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setF = function (f) {
        this.f = f;
    };
    /**
     * Getter for JFREIB.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getJFREIB = function () {
        return this.JFREIB;
    };
    /**
     * Setter for JFREIB.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setJFREIB = function (JFREIB) {
        this.JFREIB = JFREIB;
    };
    /**
     * Getter for JHINZU.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getJHINZU = function () {
        return this.JHINZU;
    };
    /**
     * Setter for JHINZU.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setJHINZU = function (JHINZU) {
        this.JHINZU = JHINZU;
    };
    /**
     * Getter for JRE4.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getJRE4 = function () {
        return this.JRE4;
    };
    /**
     * Setter for JRE4.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setJRE4 = function (JRE4) {
        this.JRE4 = JRE4;
    };
    /**
     * Getter for JVBEZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getJVBEZ = function () {
        return this.JVBEZ;
    };
    /**
     * Setter for JVBEZ.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setJVBEZ = function (JVBEZ) {
        this.JVBEZ = JVBEZ;
    };
    /**
     * Getter for KRV.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getKRV = function () {
        return this.KRV;
    };
    /**
     * Setter for KRV.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setKRV = function (KRV) {
        this.KRV = KRV;
    };
    /**
     * Getter for KVZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getKVZ = function () {
        return this.KVZ;
    };
    /**
     * Setter for KVZ.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setKVZ = function (KVZ) {
        this.KVZ = KVZ;
    };
    /**
     * Getter for LZZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getLZZ = function () {
        return this.LZZ;
    };
    /**
     * Setter for LZZ.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setLZZ = function (LZZ) {
        this.LZZ = LZZ;
    };
    /**
     * Getter for LZZFREIB.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getLZZFREIB = function () {
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setLZZFREIB = function (LZZFREIB) {
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getLZZHINZU = function () {
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setLZZHINZU = function (LZZHINZU) {
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getMBV = function () {
        return this.MBV;
    };
    /**
     * Setter for MBV.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setMBV = function (MBV) {
        this.MBV = MBV;
    };
    /**
     * Getter for PKPV.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getPKPV = function () {
        return this.PKPV;
    };
    /**
     * Setter for PKPV.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setPKPV = function (PKPV) {
        this.PKPV = PKPV;
    };
    /**
     * Getter for PKV.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getPKV = function () {
        return this.PKV;
    };
    /**
     * Setter for PKV.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setPKV = function (PKV) {
        this.PKV = PKV;
    };
    /**
     * Getter for PVS.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getPVS = function () {
        return this.PVS;
    };
    /**
     * Setter for PVS.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setPVS = function (PVS) {
        this.PVS = PVS;
    };
    /**
     * Getter for PVZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getPVZ = function () {
        return this.PVZ;
    };
    /**
     * Setter for PVZ.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setPVZ = function (PVZ) {
        this.PVZ = PVZ;
    };
    /**
     * Getter for R.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getR = function () {
        return this.R;
    };
    /**
     * Setter for R.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setR = function (R) {
        this.R = R;
    };
    /**
     * Getter for RE4.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getRE4 = function () {
        return this.RE4;
    };
    /**
     * Setter for RE4.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setRE4 = function (RE4) {
        this.RE4 = RE4;
    };
    /**
     * Getter for SONSTB.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSONSTB = function () {
        return this.SONSTB;
    };
    /**
     * Setter for SONSTB.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setSONSTB = function (SONSTB) {
        this.SONSTB = SONSTB;
    };
    /**
     * Getter for STERBE.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSTERBE = function () {
        return this.STERBE;
    };
    /**
     * Setter for STERBE.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setSTERBE = function (STERBE) {
        this.STERBE = STERBE;
    };
    /**
     * Getter for STKL.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSTKL = function () {
        return this.STKL;
    };
    /**
     * Setter for STKL.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setSTKL = function (STKL) {
        this.STKL = STKL;
    };
    /**
     * Getter for VBEZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVBEZ = function () {
        return this.VBEZ;
    };
    /**
     * Setter for VBEZ.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVBEZ = function (VBEZ) {
        this.VBEZ = VBEZ;
    };
    /**
     * Getter for VBEZM.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVBEZM = function () {
        return this.VBEZM;
    };
    /**
     * Setter for VBEZM.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVBEZM = function (VBEZM) {
        this.VBEZM = VBEZM;
    };
    /**
     * Getter for VBEZS.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVBEZS = function () {
        return this.VBEZS;
    };
    /**
     * Setter for VBEZS.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVBEZS = function (VBEZS) {
        this.VBEZS = VBEZS;
    };
    /**
     * Getter for VBS.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVBS = function () {
        return this.VBS;
    };
    /**
     * Setter for VBS.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVBS = function (VBS) {
        this.VBS = VBS;
    };
    /**
     * Getter for VJAHR.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVJAHR = function () {
        return this.VJAHR;
    };
    /**
     * Setter for VJAHR.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVJAHR = function (VJAHR) {
        this.VJAHR = VJAHR;
    };
    /**
     * Getter for VKAPA.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVKAPA = function () {
        return this.VKAPA;
    };
    /**
     * Setter for VKAPA.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVKAPA = function (VKAPA) {
        this.VKAPA = VKAPA;
    };
    /**
     * Getter for VMT.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVMT = function () {
        return this.VMT;
    };
    /**
     * Setter for VMT.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setVMT = function (VMT) {
        this.VMT = VMT;
    };
    /**
     * Getter for ZKF.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getZKF = function () {
        return this.ZKF;
    };
    /**
     * Setter for ZKF.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setZKF = function (ZKF) {
        this.ZKF = ZKF;
    };
    /**
     * Getter for ZMVB.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getZMVB = function () {
        return this.ZMVB;
    };
    /**
     * Setter for ZMVB.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setZMVB = function (ZMVB) {
        this.ZMVB = ZMVB;
    };
    /**
     * Getter for JRE4ENT.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getJRE4ENT = function () {
        return this.JRE4ENT;
    };
    /**
     * Setter for JRE4ENT.
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setJRE4ENT = function (JRE4ENT) {
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSONSTENT = function () {
     ...
     */
    Lohnsteuer2022MaiBig.prototype.setSONSTENT = function (SONSTENT) {
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getBK = function () {
        return this.BK;
    };
    /**
     * Getter for BKS.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getBKS = function () {
        return this.BKS;
    };
    /**
     * Getter for BKV.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getBKV = function () {
        return this.BKV;
    };
    /**
     * Getter for LSTLZZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getLSTLZZ = function () {
        return this.LSTLZZ;
    };
    /**
     * Getter for SOLZLZZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSOLZLZZ = function () {
        return this.SOLZLZZ;
    };
    /**
     * Getter for SOLZS.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSOLZS = function () {
        return this.SOLZS;
    };
    /**
     * Getter for SOLZV.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSOLZV = function () {
        return this.SOLZV;
    };
    /**
     * Getter for STS.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSTS = function () {
        return this.STS;
    };
    /**
     * Getter for STV.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getSTV = function () {
        return this.STV;
    };
    /**
     * Getter for VKVLZZ.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVKVLZZ = function () {
        return this.VKVLZZ;
    };
    /**
     * Getter for VKVSONST.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVKVSONST = function () {
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVFRB = function () {
        return this.VFRB;
    };
    /**
     * Getter for VFRBS1.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVFRBS1 = function () {
        return this.VFRBS1;
    };
    /**
     * Getter for VFRBS2.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getVFRBS2 = function () {
        return this.VFRBS2;
    };
    /**
     * Getter for WVFRB.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getWVFRB = function () {
        return this.WVFRB;
    };
    /**
     * Getter for WVFRBO.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getWVFRBO = function () {
        return this.WVFRBO;
    };
    /**
     * Getter for WVFRBM.
     ...
     * @return the value
     */
    Lohnsteuer2022MaiBig.prototype.getWVFRBM = function () {
        return this.WVFRBM;
    };
    /**
     * Initialize all inputs values with zero.
     */
    Lohnsteuer2022MaiBig.prototype.initInputs = function () {
    ...
    Lohnsteuer2022MaiBig.prototype.isBigInput = function (name, value) {
     ...
     */
    Lohnsteuer2022MaiBig.prototype.set = function (name, value) {
     ...
     */
    Lohnsteuer2022MaiBig.prototype.get = function (name) {
        if (this.hasOwnProperty(name)) {
            return this[name];
        }
        throw new Error("Unknown parameter " + name);
     ...
     */
    Lohnsteuer2022MaiBig.prototype.getDirectory = function () {
        return Lohnsteuer2022MaiBig.typeDirectory;
    };
    /**
     ...
     */
    Lohnsteuer2022MaiBig.prototype.toType = function (name, value) {
        var info = Lohnsteuer2022MaiBig.typeDirectory[name];
        if (!info) {
            throw new Error("Unknown parameter " + name);
        }
    ...
    Lohnsteuer2022MaiBig._n = "number";
    Lohnsteuer2022MaiBig._b = "Big";
    Lohnsteuer2022MaiBig._i = "input";
    Lohnsteuer2022MaiBig._o = "output";
    Lohnsteuer2022MaiBig._s = "STANDARD";
    Lohnsteuer2022MaiBig._d = "DBA";
    Lohnsteuer2022MaiBig.typeDirectory = {
        "af": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "AJAHR": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "ALTER1": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "ENTSCH": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "f": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "JFREIB": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "JHINZU": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "JRE4": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "JVBEZ": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "KRV": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "KVZ": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "LZZ": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "LZZFREIB": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "LZZHINZU": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "MBV": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "PKPV": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "PKV": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "PVS": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "PVZ": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "R": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "RE4": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "SONSTB": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "STERBE": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "STKL": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "VBEZ": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "VBEZM": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "VBEZS": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "VBS": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "VJAHR": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "VKAPA": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "VMT": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "ZKF": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "ZMVB": { type: Lohnsteuer2022MaiBig._n, direction: Lohnsteuer2022MaiBig._i }, "JRE4ENT": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "SONSTENT": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._i }, "BK": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "BKS": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "BKV": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "LSTLZZ": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "SOLZLZZ": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "SOLZS": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "SOLZV": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "STS": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "STV": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "VKVLZZ": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "VKVSONST": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._s }, "VFRB": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._d }, "VFRBS1": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._d }, "VFRBS2": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._d }, "WVFRB": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._d }, "WVFRBO": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._d }, "WVFRBM": { type: Lohnsteuer2022MaiBig._b, direction: Lohnsteuer2022MaiBig._o, group: Lohnsteuer2022MaiBig._d },
    };
    return Lohnsteuer2022MaiBig;
}());
//# sourceMappingURL=Lohnsteuer2022MaiBig.js.map
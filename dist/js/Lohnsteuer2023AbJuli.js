...
var Lohnsteuer2023AbJuliBig = /** @class */ (function () {
    ...
    Lohnsteuer2023AbJuliBig.prototype.MPARA = function () {
        ...
        this.KVSATZAG = new Big(0.008).add(new Big(0.07)); /**  Bugfix für 2023 ab Juli */
        /**  Neu ab 2023AbJuli  */
        if (this.LZZ == 1) {
            if (this.PVS == 1) {
                this.PVSATZAN = new Big(0.021125);
                this.PVSATZAG = new Big(0.011125);
            }
            else {
                this.PVSATZAN = new Big(0.016125);
                this.PVSATZAG = new Big(0.016125);
            }
            if (this.PVZ == 1) {
                this.PVSATZAN = this.PVSATZAN.add(new Big(0.00475));
            }
        }
        else {
            if (this.PVS == 1) {

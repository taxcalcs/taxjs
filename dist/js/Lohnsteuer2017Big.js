...
var Lohnsteuer2017Big = /** @class */ (function () {
    ...
    Lohnsteuer2017Big.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(76200); /**  Neu 2017  */
            }
            else {
                this.BBGRV = new Big(68400); /**  Neu 2017  */
            }
            this.RVSATZAN = new Big(0.0935);
            this.TBSVORV = new Big(0.68); /**  Neu 2017  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this.BBGKVPV = new Big(52200); /**  Neu 2017  */
        this.KVSATZAN = (this.KVZ.div(this.ZAHL100)).add(new Big(0.07));
        this.KVSATZAG = new Big(0.07);
        if (this.PVS == 1) {
            this.PVSATZAN = new Big(0.01775); /**  Neu 2017  */
            this.PVSATZAG = new Big(0.00775); /**  Neu 2017  */
        }
        else {
            this.PVSATZAN = new Big(0.01275); /**  Neu 2017  */
            this.PVSATZAG = new Big(0.01275); /**  Neu 2017  */
        }
        if (this.PVZ == 1) {
            this.PVSATZAN = this.PVSATZAN.add(new Big(0.0025));
        }
        /**  Anfang Neu 2017  */
        this.W1STKL5 = new Big(10240);
        this.W2STKL5 = new Big(27029);
        this.W3STKL5 = new Big(205043);
        this.GFB = new Big(8820);
        /**  Ende Neu 2017  */
    ...
    Lohnsteuer2017Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7356))).round(0, Big.roundDown); /**  Neu 2017  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3678))).round(0, Big.roundDown); /**  Neu 2017  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    Lohnsteuer2017Big.prototype.UPTAB17 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(13770)) == -1) {
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(1007.27));
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, Big.roundDown);
            }
            else {
                if (this.X.cmp(new Big(54058)) == -1) {
                    this.Y = (this.X.sub(new Big(13769))).div(this.ZAHL10000).round(6, Big.roundDown);
                    this.RW = this.Y.mul(new Big(223.76));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(939.57))).round(0, Big.roundDown);
                }
                else {
                    if (this.X.cmp(new Big(256304)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8475.44))).round(0, Big.roundDown);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16164.53))).round(0, Big.roundDown);
                    }
                }
            }
        }

...
var Lohnsteuer2015Big = /** @class */ (function () {
    ...
    Lohnsteuer2015Big.prototype.MST5_6 = function () {
        ...
        if (this.ZZX.cmp(new Big(26441)) == 1) {
            ...
            if (this.ZZX.cmp(new Big(9763)) == 1) {
                ...
                this.UP5_6();
                this.HOCH = (this.ST.add((this.ZZX.sub(new Big(9763))).mul(new Big(0.42)))).round(0, 0 /* RoundDown */); /**  Neuer Wert 2014  */
    ...
    Lohnsteuer2015Big.prototype.UPTAB14 = function () {
        if (this.X.cmp(new Big(8355)) == -1) {
            ...
            if (this.X.cmp(new Big(13470)) == -1) {
                this.Y = (this.X.sub(new Big(8354))).div(new Big(10000)).round(6, 0 /* RoundDown */);
                ...
                if (this.X.cmp(new Big(52882)) == -1) {
                    ...
                    this.ST = (this.RW.add(new Big(971))).round(0, 0 /* RoundDown */);
                }
                else {
                    if (this.X.cmp(new Big(250731)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8239))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(15761))).round(0, 0 /* RoundDown */);
                    }
                }
            }
        }
     ...
     */
    Lohnsteuer2015Big.prototype.setBig = function (name, value) {
     ...
     */
    Lohnsteuer2015Big.prototype.setNumber = function (name, value) {
        if (this.hasOwnProperty(name)) {
            this[name] = value;
        }
        else {

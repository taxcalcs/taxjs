...
*
*/
var Lohnsteuer2015Big = /** @class */ (function () {
    function Lohnsteuer2015Big() {
        this.Z_0 = new Big(0);
        this.Z_1 = new Big(1);
    ...
    Lohnsteuer2015Big.prototype.calculate = function () {
        this.MPARA(); /**  Neu 2015  */
        this.MRE4JL();
        this.VBEZBSO = this.Z_0;
        this.KENNVMT = 0;
    ...
    Lohnsteuer2015Big.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(72600);
            }
            else {
                this.BBGRV = new Big(62400);
            }
            this.RVSATZAN = new Big(0.0935);
            this.TBSVORV = new Big(0.60);
        }
        else {
            /**  Nichts zu tun  */
        }
        this.BBGKVPV = new Big(49500);
    ...
    Lohnsteuer2015Big.prototype.MRE4JL = function () {
        if (this.LZZ == 1) {
    ...
    Lohnsteuer2015Big.prototype.MRE4 = function () {
    ...
    Lohnsteuer2015Big.prototype.MRE4ALTE = function () {
        if (this.ALTER1 == 0) {
            this.ALTE = this.Z_0;
        }
        else {
    ...
    Lohnsteuer2015Big.prototype.MRE4ABZ = function () {
    ...
    Lohnsteuer2015Big.prototype.MZTABFB = function () {
        this.ANP = this.Z_0;
    ...
    Lohnsteuer2015Big.prototype.MLSTJAHR = function () {
        this.UPEVP();
        if (this.KENNVMT != 1) {
    ...
    /**  PAP Seite 21  */
    Lohnsteuer2015Big.prototype.UPVKVLZZ = function () {
        this.UPVKV();
        this.JW = this.VKV;
        this.UPANTEIL();
    ...
    /**  PAP Seite 21  */
    Lohnsteuer2015Big.prototype.UPVKV = function () {
        if (this.PKV > 0) {
    ...
    /**  	Vorsorgepauschale (§ 39b Absatz 2 Satz 5 Nummer 3 und Absatz 4 EStG)
              ...
              PAP Seite 23   */
    Lohnsteuer2015Big.prototype.UPEVP = function () {
        if (this.KRV > 1) { /**  &lt; = < &gt; = >  */
            this.VSP1 = this.Z_0;
        }
        else {
    ...
    Lohnsteuer2015Big.prototype.MVSP = function () {
    ...
    /**    */
    Lohnsteuer2015Big.prototype.UMVSP = function () {
    ...
    Lohnsteuer2015Big.prototype.MST5_6 = function () {
        this.ZZX = this.X;
        if (this.ZZX.cmp(new Big(26441)) == 1) {
            ...
            this.ZX = this.ZZX;
            this.UP5_6();
            if (this.ZZX.cmp(new Big(9763)) == 1) {
                this.VERGL = this.ST;
                this.ZX = new Big(9763);
                this.UP5_6();
                this.HOCH = (this.ST.add((this.ZZX.sub(new Big(9763))).mul(new Big(0.42)))).round(0, Big.roundDown); /**  Neuer Wert 2014  */
    ...
    Lohnsteuer2015Big.prototype.UP5_6 = function () {
    ...
    Lohnsteuer2015Big.prototype.MSOLZ = function () {
    ...
    Lohnsteuer2015Big.prototype.UPANTEIL = function () {
        if (this.LZZ == 1) {
    ...
    Lohnsteuer2015Big.prototype.MSONST = function () {
        this.LZZ = 1;
        if (this.ZMVB == 0) {
            this.ZMVB = 12;
        }
    ...
    Lohnsteuer2015Big.prototype.MVMT = function () {
    ...
    Lohnsteuer2015Big.prototype.MOSONST = function () {
    ...
    Lohnsteuer2015Big.prototype.MRE4SONST = function () {
        this.MRE4();
        this.FVB = this.FVBSO;
        this.MRE4ABZ();
        this.ZRE4VP = this.ZRE4VP.sub(this.JRE4ENT.div(this.ZAHL100)).sub(this.SONSTENT.div(this.ZAHL100));
    ...
    Lohnsteuer2015Big.prototype.UPTAB14 = function () {
        if (this.X.cmp(new Big(8355)) == -1) {
            this.ST = this.Z_0;
        }
        else {
            if (this.X.cmp(new Big(13470)) == -1) {
                this.Y = (this.X.sub(new Big(8354))).div(new Big(10000)).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(974.58));
                ...
                if (this.X.cmp(new Big(52882)) == -1) {
                    ...
                    this.ST = (this.RW.add(new Big(971))).round(0, Big.roundDown);
                }
                else {
                    if (this.X.cmp(new Big(250731)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8239))).round(0, Big.roundDown);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(15761))).round(0, Big.roundDown);
                    }
                }
            }
        }
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getAf = function () {
        return this.af;
    };
    /**
     * Setter for af.
     ...
     */
    Lohnsteuer2015Big.prototype.setAf = function (af) {
        this.af = af;
    };
    /**
     * Getter for AJAHR.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getAJAHR = function () {
        return this.AJAHR;
    };
    /**
     * Setter for AJAHR.
     ...
     */
    Lohnsteuer2015Big.prototype.setAJAHR = function (AJAHR) {
        this.AJAHR = AJAHR;
    };
    /**
     * Getter for ALTER1.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getALTER1 = function () {
        return this.ALTER1;
    };
    /**
     * Setter for ALTER1.
     ...
     */
    Lohnsteuer2015Big.prototype.setALTER1 = function (ALTER1) {
        this.ALTER1 = ALTER1;
    };
    /**
     * Getter for ENTSCH.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getENTSCH = function () {
        return this.ENTSCH;
    };
    /**
     * Setter for ENTSCH.
     ...
     */
    Lohnsteuer2015Big.prototype.setENTSCH = function (ENTSCH) {
        this.ENTSCH = ENTSCH;
    };
    /**
     * Getter for f.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getF = function () {
        return this.f;
    };
    /**
     * Setter for f.
     ...
     */
    Lohnsteuer2015Big.prototype.setF = function (f) {
        this.f = f;
    };
    /**
     * Getter for JFREIB.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getJFREIB = function () {
        return this.JFREIB;
    };
    /**
     * Setter for JFREIB.
     ...
     */
    Lohnsteuer2015Big.prototype.setJFREIB = function (JFREIB) {
        this.JFREIB = JFREIB;
    };
    /**
     * Getter for JHINZU.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getJHINZU = function () {
        return this.JHINZU;
    };
    /**
     * Setter for JHINZU.
     ...
     */
    Lohnsteuer2015Big.prototype.setJHINZU = function (JHINZU) {
        this.JHINZU = JHINZU;
    };
    /**
     * Getter for JRE4.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getJRE4 = function () {
        return this.JRE4;
    };
    /**
     * Setter for JRE4.
     ...
     */
    Lohnsteuer2015Big.prototype.setJRE4 = function (JRE4) {
        this.JRE4 = JRE4;
    };
    /**
     * Getter for JVBEZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getJVBEZ = function () {
        return this.JVBEZ;
    };
    /**
     * Setter for JVBEZ.
     ...
     */
    Lohnsteuer2015Big.prototype.setJVBEZ = function (JVBEZ) {
        this.JVBEZ = JVBEZ;
    };
    /**
     * Getter for KRV.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getKRV = function () {
        return this.KRV;
    };
    /**
     * Setter for KRV.
     ...
     */
    Lohnsteuer2015Big.prototype.setKRV = function (KRV) {
        this.KRV = KRV;
    };
    /**
     * Getter for KVZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getKVZ = function () {
        return this.KVZ;
    };
    /**
     * Setter for KVZ.
     ...
     */
    Lohnsteuer2015Big.prototype.setKVZ = function (KVZ) {
        this.KVZ = KVZ;
    };
    /**
     * Getter for LZZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getLZZ = function () {
        return this.LZZ;
    };
    /**
     * Setter for LZZ.
     ...
     */
    Lohnsteuer2015Big.prototype.setLZZ = function (LZZ) {
        this.LZZ = LZZ;
    };
    /**
     * Getter for LZZFREIB.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getLZZFREIB = function () {
     ...
     */
    Lohnsteuer2015Big.prototype.setLZZFREIB = function (LZZFREIB) {
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getLZZHINZU = function () {
     ...
     */
    Lohnsteuer2015Big.prototype.setLZZHINZU = function (LZZHINZU) {
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getPKPV = function () {
        return this.PKPV;
    };
    /**
     * Setter for PKPV.
     ...
     */
    Lohnsteuer2015Big.prototype.setPKPV = function (PKPV) {
        this.PKPV = PKPV;
    };
    /**
     * Getter for PKV.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getPKV = function () {
        return this.PKV;
    };
    /**
     * Setter for PKV.
     ...
     */
    Lohnsteuer2015Big.prototype.setPKV = function (PKV) {
        this.PKV = PKV;
    };
    /**
     * Getter for PVS.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getPVS = function () {
        return this.PVS;
    };
    /**
     * Setter for PVS.
     ...
     */
    Lohnsteuer2015Big.prototype.setPVS = function (PVS) {
        this.PVS = PVS;
    };
    /**
     * Getter for PVZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getPVZ = function () {
        return this.PVZ;
    };
    /**
     * Setter for PVZ.
     ...
     */
    Lohnsteuer2015Big.prototype.setPVZ = function (PVZ) {
        this.PVZ = PVZ;
    };
    /**
     * Getter for R.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getR = function () {
        return this.R;
    };
    /**
     * Setter for R.
     ...
     */
    Lohnsteuer2015Big.prototype.setR = function (R) {
        this.R = R;
    };
    /**
     * Getter for RE4.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getRE4 = function () {
        return this.RE4;
    };
    /**
     * Setter for RE4.
     ...
     */
    Lohnsteuer2015Big.prototype.setRE4 = function (RE4) {
        this.RE4 = RE4;
    };
    /**
     * Getter for SONSTB.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSONSTB = function () {
        return this.SONSTB;
    };
    /**
     * Setter for SONSTB.
     ...
     */
    Lohnsteuer2015Big.prototype.setSONSTB = function (SONSTB) {
        this.SONSTB = SONSTB;
    };
    /**
     * Getter for STERBE.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSTERBE = function () {
        return this.STERBE;
    };
    /**
     * Setter for STERBE.
     ...
     */
    Lohnsteuer2015Big.prototype.setSTERBE = function (STERBE) {
        this.STERBE = STERBE;
    };
    /**
     * Getter for STKL.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSTKL = function () {
        return this.STKL;
    };
    /**
     * Setter for STKL.
     ...
     */
    Lohnsteuer2015Big.prototype.setSTKL = function (STKL) {
        this.STKL = STKL;
    };
    /**
     * Getter for VBEZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVBEZ = function () {
        return this.VBEZ;
    };
    /**
     * Setter for VBEZ.
     ...
     */
    Lohnsteuer2015Big.prototype.setVBEZ = function (VBEZ) {
        this.VBEZ = VBEZ;
    };
    /**
     * Getter for VBEZM.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVBEZM = function () {
        return this.VBEZM;
    };
    /**
     * Setter for VBEZM.
     ...
     */
    Lohnsteuer2015Big.prototype.setVBEZM = function (VBEZM) {
        this.VBEZM = VBEZM;
    };
    /**
     * Getter for VBEZS.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVBEZS = function () {
        return this.VBEZS;
    };
    /**
     * Setter for VBEZS.
     ...
     */
    Lohnsteuer2015Big.prototype.setVBEZS = function (VBEZS) {
        this.VBEZS = VBEZS;
    };
    /**
     * Getter for VBS.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVBS = function () {
        return this.VBS;
    };
    /**
     * Setter for VBS.
     ...
     */
    Lohnsteuer2015Big.prototype.setVBS = function (VBS) {
        this.VBS = VBS;
    };
    /**
     * Getter for VJAHR.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVJAHR = function () {
        return this.VJAHR;
    };
    /**
     * Setter for VJAHR.
     ...
     */
    Lohnsteuer2015Big.prototype.setVJAHR = function (VJAHR) {
        this.VJAHR = VJAHR;
    };
    /**
     * Getter for VKAPA.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVKAPA = function () {
        return this.VKAPA;
    };
    /**
     * Setter for VKAPA.
     ...
     */
    Lohnsteuer2015Big.prototype.setVKAPA = function (VKAPA) {
        this.VKAPA = VKAPA;
    };
    /**
     * Getter for VMT.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVMT = function () {
        return this.VMT;
    };
    /**
     * Setter for VMT.
     ...
     */
    Lohnsteuer2015Big.prototype.setVMT = function (VMT) {
        this.VMT = VMT;
    };
    /**
     * Getter for ZKF.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getZKF = function () {
        return this.ZKF;
    };
    /**
     * Setter for ZKF.
     ...
     */
    Lohnsteuer2015Big.prototype.setZKF = function (ZKF) {
        this.ZKF = ZKF;
    };
    /**
     * Getter for ZMVB.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getZMVB = function () {
        return this.ZMVB;
    };
    /**
     * Setter for ZMVB.
     ...
     */
    Lohnsteuer2015Big.prototype.setZMVB = function (ZMVB) {
        this.ZMVB = ZMVB;
    };
    /**
     * Getter for JRE4ENT.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getJRE4ENT = function () {
        return this.JRE4ENT;
    };
    /**
     * Setter for JRE4ENT.
     ...
     */
    Lohnsteuer2015Big.prototype.setJRE4ENT = function (JRE4ENT) {
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSONSTENT = function () {
     ...
     */
    Lohnsteuer2015Big.prototype.setSONSTENT = function (SONSTENT) {
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getBK = function () {
        return this.BK;
    };
    /**
     * Getter for BKS.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getBKS = function () {
        return this.BKS;
    };
    /**
     * Getter for BKV.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getBKV = function () {
        return this.BKV;
    };
    /**
     * Getter for LSTLZZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getLSTLZZ = function () {
        return this.LSTLZZ;
    };
    /**
     * Getter for SOLZLZZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSOLZLZZ = function () {
        return this.SOLZLZZ;
    };
    /**
     * Getter for SOLZS.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSOLZS = function () {
        return this.SOLZS;
    };
    /**
     * Getter for SOLZV.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSOLZV = function () {
        return this.SOLZV;
    };
    /**
     * Getter for STS.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSTS = function () {
        return this.STS;
    };
    /**
     * Getter for STV.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getSTV = function () {
        return this.STV;
    };
    /**
     * Getter for VKVLZZ.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVKVLZZ = function () {
        return this.VKVLZZ;
    };
    /**
     * Getter for VKVSONST.
     ...
     * @return the value
     */
    Lohnsteuer2015Big.prototype.getVKVSONST = function () {
        return this.VKVSONST;
    };
    /**
     * Initialize all inputs values with zero.
     */
    Lohnsteuer2015Big.prototype.initInputs = function () {
    ...
    Lohnsteuer2015Big.prototype.isBigInput = function (name, value) {
     ...
     */
    Lohnsteuer2015Big.prototype.set = function (name, value) {
     ...
     */
    Lohnsteuer2015Big.prototype.get = function (name) {
        if (this.hasOwnProperty(name)) {
            return this[name];
        }
        throw new Error("Unknown parameter " + name);
     ...
     */
    Lohnsteuer2015Big.prototype.getDirectory = function () {
        return Lohnsteuer2015Big.typeDirectory;
    };
    /**
     ...
     */
    Lohnsteuer2015Big.prototype.toType = function (name, value) {
        var info = Lohnsteuer2015Big.typeDirectory[name];
        if (!info) {
            throw new Error("Unknown parameter " + name);
        }
    ...
    Lohnsteuer2015Big._n = "number";
    Lohnsteuer2015Big._b = "Big";
    Lohnsteuer2015Big._i = "input";
    Lohnsteuer2015Big._o = "output";
    Lohnsteuer2015Big._s = "STANDARD";
    Lohnsteuer2015Big._d = "DBA";
    Lohnsteuer2015Big.typeDirectory = {
        "af": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "AJAHR": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "ALTER1": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "ENTSCH": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "f": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "JFREIB": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "JHINZU": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "JRE4": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "JVBEZ": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "KRV": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "KVZ": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "LZZ": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "LZZFREIB": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "LZZHINZU": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "PKPV": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "PKV": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "PVS": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "PVZ": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "R": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "RE4": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "SONSTB": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "STERBE": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "STKL": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "VBEZ": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "VBEZM": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "VBEZS": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "VBS": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "VJAHR": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "VKAPA": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "VMT": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "ZKF": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "ZMVB": { type: Lohnsteuer2015Big._n, direction: Lohnsteuer2015Big._i }, "JRE4ENT": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "SONSTENT": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._i }, "BK": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "BKS": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "BKV": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "LSTLZZ": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "SOLZLZZ": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "SOLZS": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "SOLZV": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "STS": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "STV": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "VKVLZZ": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s }, "VKVSONST": { type: Lohnsteuer2015Big._b, direction: Lohnsteuer2015Big._o, group: Lohnsteuer2015Big._s },
    };
    return Lohnsteuer2015Big;
}());
//# sourceMappingURL=Lohnsteuer2015Big.js.map
...
var Lohnsteuer2019Big = /** @class */ (function () {
    ...
    Lohnsteuer2019Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7620))).round(0, 0 /* RoundDown */); /**  Neu 2019  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3810))).round(0, 0 /* RoundDown */); /**  Neu 2019  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
        ...
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14255)) == -1) {
                ...
                if (this.X.cmp(new Big(55961)) == -1) {
                    this.Y = (this.X.sub(new Big(14254))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                    this.RW = this.Y.mul(new Big(216.16));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(965.58))).round(0, 0 /* RoundDown */);
                }
                else {
                    if (this.X.cmp(new Big(265327)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8780.9))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16740.68))).round(0, 0 /* RoundDown */);
                    }
                }
            }
        }

...
var Lohnsteuer2019Big = /** @class */ (function () {
    ...
    Lohnsteuer2019Big.prototype.MPARA = function () {
        if (this.KRV < 2) { /**  &lt; = <  */
            if (this.KRV == 0) {
                this.BBGRV = new Big(80400); /**  Neu 2019  */
            }
            else {
                this.BBGRV = new Big(73800); /**  Neu 2019  */
            }
            this.RVSATZAN = new Big(0.093); /**  Neu 2019  */
            this.TBSVORV = new Big(0.76); /**  Neu 2019  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this.BBGKVPV = new Big(54450); /**  Neu 2019  */
        this.bd = new Big(2); /**  Neu 2019  */
        this.KVSATZAN = (this.KVZ.div(this.bd).div(this.ZAHL100)).add(new Big(0.07)); /**  Neu 2019  */
        this.KVSATZAG = new Big(0.0045 + 0.07); /**  Neu 2019  */
        if (this.PVS == 1) {
        ...
        /**  Anfang Neu 2019  */
        this.W1STKL5 = new Big(10635);
        this.W2STKL5 = new Big(27980);
        this.W3STKL5 = new Big(212261);
        this.GFB = new Big(9168);
        /**  Ende Neu 2019  */
    ...
    Lohnsteuer2019Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7620))).round(0, Big.roundDown); /**  Neu 2019  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3810))).round(0, Big.roundDown); /**  Neu 2019  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    Lohnsteuer2019Big.prototype.UPTAB19 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14255)) == -1) {
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(980.14));
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, Big.roundDown);
            }
            else {
                if (this.X.cmp(new Big(55961)) == -1) {
                    this.Y = (this.X.sub(new Big(14254))).div(this.ZAHL10000).round(6, Big.roundDown);
                    this.RW = this.Y.mul(new Big(216.16));
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(965.58))).round(0, Big.roundDown);
                }
                else {
                    if (this.X.cmp(new Big(265327)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8780.9))).round(0, Big.roundDown);
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(16740.68))).round(0, Big.roundDown);
                    }
                }
            }
        }

...
var Lohnsteuer2020Big = /** @class */ (function () {
    ...
    Lohnsteuer2020Big.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(7812))).round(0, Big.roundDown); /**  Neu 2020  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(3906))).round(0, Big.roundDown); /**  Neu 2020  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
        ...
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(14533)) == -1) { /**  neu seit 2020  */
                ...
                if (this.X.cmp(new Big(57052)) == -1) { /**  neu seit 2020  */
                    this.Y = (this.X.sub(new Big(14532))).div(this.ZAHL10000).round(6, Big.roundDown);
                    this.RW = this.Y.mul(new Big(212.02)); /**  neu seit 2020  */
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(972.79))).round(0, Big.roundDown); /**  neu seit 2020  */
                }
                else {
                    if (this.X.cmp(new Big(270501)) == -1) { /**  neu seit 2020  */
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(8963.74))).round(0, Big.roundDown); /**  neu seit 2020  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(17078.74))).round(0, Big.roundDown); /**  neu seit 2020  */
                    }
                }
            }
        }

define(["require", "exports", "big.js"], function (require, exports, big_js_1) {
    ...
    */
    var Lohnsteuer2011DecemberBig = /** @class */ (function () {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.getBig = function (name) {
            switch (name) {
         ...
         * @param {String} name Variable name to get.
         */
        Lohnsteuer2011DecemberBig.prototype.getNumber = function (name) {
            switch (name) {
                default:
                    throw new Error("Unknown number parameter " + name);
            }
         ...
         * Get all input names.
         */
        Lohnsteuer2011DecemberBig.prototype.getInputs = function () {
            return [
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.getOutputs = function () {
            return [

...
* 
*/
export class Lohnsteuer2010Big implements TaxJs {
    ...
    /**   AUSGABEPARAMETER   */
        ...
        private KVSATZAG : Big = this.Z_0.round(5);

        /**  Beitragssatz des Arbeitnehmers zur Krankenversicherung (5 Dezimalstellen)  */
        private KVSATZAN : Big = this.Z_0.round(5);
       ...
       /**  Kennzahl fuer die Einkommensteuer-Tabellenart:
        ...
        private PVSATZAG : Big = this.Z_0.round(5);

        /**  Beitragssatz des Arbeitnehmers zur Pflegeversicherung (5 Dezimalstellen)  */
        private PVSATZAN : Big = this.Z_0.round(5);
  ...
  private UPEVP() : void {
    if (this.KRV > 1) {
        ...
        this.VSP1= this.Z_0;
		        ...
		        this.VSP1= (this.ZRE4VP.mul (new Big (0.4))).round (2, RoundingMode.RoundDown);

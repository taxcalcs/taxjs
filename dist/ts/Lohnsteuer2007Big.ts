...
* 
*/
export class Lohnsteuer2007Big implements TaxJs {
...
/**  Achtung! Rechengenauigkeit Division?  */	
        ...
        this.FVB= (this.VBEZB.mul (this.TAB1[this.J])).round (2, RoundingMode.RoundUp);
    ...
    if (this.LZZ == 1) {
        ...
        if (this.LZZ == 2) {
            ...
            if (this.LZZ == 3) {
                ...
                this.ZRE4= ((this.RE4LZZ.add (new Big (0.89))).mul (new Big (3.6))).div(new Big (7.0)).round( 2, RoundingMode.RoundDown);
                this.ZRE4VP= ((this.RE4LZZV.add (new Big (0.89))).mul (new Big (3.6))).div(new Big (7.0)).round( 2, RoundingMode.RoundDown);
                this.ZVBEZ= ((this.VBEZ.sub (this.FVB).add (new Big (0.89))).mul (new Big (3.6))).div(new Big (7.0)).round( 2, RoundingMode.RoundDown);
   ...
   */
    ...
    if (this.KRV == 1) {
        ...
        this.VSP1= (this.ZRE4VP.mul (new Big (0.28))).round (2, RoundingMode.RoundDown);

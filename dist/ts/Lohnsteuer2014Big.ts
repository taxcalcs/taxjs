...
* 
*/
export class Lohnsteuer2014Big implements TaxJs {
    ...
    /**   AUSGABEPARAMETER   */
        ...
        /**  Für den Lohnzahlungszeitraum berücksichtigte Beiträge des Arbeitnehmers zur
			 ...
			 VKVSONST  */
		private VKVLZZ : Big = this.Z_0; /**  Neu 2014 Ursprünglich INTERNAL definiert  */
		...
		private VKVSONST : Big = this.Z_0; /** Neu 2014 Ursprünglich INTERNAL definiert  */
       ...
       /**  Kennzahl fuer die Einkommensteuer-Tabellenart:
        ...
        /**  Neuer Wert  2014  */
    	private readonly RENTBEMESSUNGSGR_OST : Big = new Big(60000);
    	
    	/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
    	/**  Neuer Wert 2014  */
    	private readonly RENTBEMESSUNGSGR_WEST : Big = new Big(71400);
    ...
    if (this.KRV > 1) {
        ...
        this.VSP1= this.Z_0;
		        ...
		        if (this.KRV == 0) {
		         ...
		         /**  Neuer Wert 2014  */ 
		        this.VSP1 = (this.ZRE4VP.mul(new Big(0.56))).round(2,RoundingMode.RoundDown);
		        this.VSP1 = (this.VSP1.mul(new Big(0.0945))).round(2,RoundingMode.RoundDown);
  ...
  private MST5_6() : void {
    ...
    if (this.ZZX.cmp (new Big (26441)) == 1) {
        ...
        if (this.ZZX.cmp (new Big (9763)) == 1) { /**  Neuer Wert 2014  */
            ...
            this.UP5_6();
            this.HOCH= (this.ST.add ((this.ZZX.sub (new Big (9763))).mul (new Big (0.42)))).round (0, RoundingMode.RoundDown); /**  Neuer Wert 2014  */
  ...
  private UPTAB14() : void {
    if (this.X.cmp (new Big (8355)) == -1) { /**  Neuer Wert 2014  */
        ...
        if (this.X.cmp (new Big (13470)) == -1) {
            ...
            this.Y= (this.X.sub (new Big (8354))).div(new Big (10000)).round( 6, RoundingMode.RoundDown); /**  Neuer Wert 2014  */
            ...
            if (this.X.cmp (new Big (52882)) == -1) {
                ...
                this.ST= (this.RW.add (new Big (971))).round (0, RoundingMode.RoundDown); /**  Neuer Wert 2014  */

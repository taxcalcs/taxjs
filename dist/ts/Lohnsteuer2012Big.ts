...
* 
*/
export class Lohnsteuer2012Big implements TaxJs {
    ...
    /**   INTERNE FELDER   */
       ...
       /**  Kennzahl fuer die Einkommensteuer-Tabellenart:
    	...
    	private readonly RENTBEMESSUNGSGR_OST_2012 : Big = new Big(57600);
    	
    	/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
    	private readonly RENTBEMESSUNGSGR_WEST : Big = new Big(67200);
  ...
  private UPEVP() : void {
    if (this.KRV > 1) {
        ...
        this.VSP1= this.Z_0;
		        ...
		        this.VSP1 = (this.ZRE4VP.mul(new Big(0.48))).round(2,RoundingMode.RoundDown);
		        this.VSP1 = (this.VSP1.mul(new Big(0.098))).round(2,RoundingMode.RoundDown);

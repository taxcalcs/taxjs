...
* 
*/
export class Lohnsteuer2017Big implements TaxJs {
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 21  */
  private MZTABFB() : void { 
    ...
    if (this.STKL == 1) {
        ...
        this.SAP= new Big (36);
        this.KFB= (this.ZKF.mul (new Big (7356))).round (0, RoundingMode.RoundDown); /**  Neu 2017  */
					...
					if (this.STKL == 3) {
					        ...
					        this.KFB= (this.ZKF.mul (new Big (7356))).round (0, RoundingMode.RoundDown); /**  Neu 2017  */
						  	...
						  	if (this.STKL == 4) {
						        ...
						        this.SAP= new Big (36);
						        this.KFB= (this.ZKF.mul (new Big (3678))).round (0, RoundingMode.RoundDown); /**  Neu 2017  */
    ...
    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) { 
        ...
        if (this.X.cmp (new Big (13770)) == -1) {
            ...
            if (this.X.cmp (new Big (54058)) == -1) {
                ...
                this.Y= (this.X.sub (new Big (13769))).div(this.ZAHL10000).round( 6, RoundingMode.RoundDown);
                this.RW= this.Y.mul (new Big (223.76));
                this.RW= this.RW.add (new Big (2397));
                this.RW= this.RW.mul (this.Y);
                this.ST= (this.RW.add (new Big (939.57))).round (0, RoundingMode.RoundDown); 
              
              }else {
	            if (this.X.cmp (new Big (256304)) == -1) {
	              
                    this.ST= ((this.X.mul (new Big (0.42))).sub (new Big (8475.44))).round (0, RoundingMode.RoundDown); 
                  
                  }else {
                    this.ST= ((this.X.mul (new Big (0.45))).sub (new Big (16164.53))).round (0, RoundingMode.RoundDown); 

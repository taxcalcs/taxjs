...
* 
*/
export class Lohnsteuer2021Big implements TaxJs {
  ...
  private MZTABFB() : void { 
    ...
    if (this.STKL == 1) {
        ...
        this.SAP= new Big (36);
        this.KFB= (this.ZKF.mul (new Big (8388))).round (0, RoundingMode.RoundDown); /**  Geändert für 2021  */
					...
					if (this.STKL == 3) {
					        ...
					        this.KFB= (this.ZKF.mul (new Big (8388))).round (0, RoundingMode.RoundDown); /**  Geändert für 2021  */
						  	...
						  	if (this.STKL == 4) {
						        ...
						        this.SAP= new Big (36);
						        this.KFB= (this.ZKF.mul (new Big (4194))).round (0, RoundingMode.RoundDown); /**  Geändert für 2021  */
  ...
  private MSOLZ() : void {
    ...
    if (this.JBMG.cmp (this.SOLZFREI) == 1) {
        ...
        this.SOLZMIN= (this.JBMG.sub (this.SOLZFREI)).mul (new Big (11.9)).div (this.ZAHL100).round (2, RoundingMode.RoundDown); /**  Änderung für 2021  */
  ...
  private MSOLZSTS() : void {
    ...
    if (this.SOLZSZVE.cmp(this.ZAHL1) == -1) { /**  SOLZSZVE < 1  */
        ...
        this.X= this.Z_0;
      	...
      	this.X= this.SOLZSZVE.div(new Big(this.KZTAB)).round( 0, RoundingMode.RoundDown);
    ...
    this.SOLZSBMG= this.ST.mul(new Big(this.f)).round(0,RoundingMode.RoundDown);
  ...
  private MVMT() : void {
    ...
    if ((this.VMT.add (this.VKAPA)).cmp (this.Z_0) == 1) {
        ...
        /**  Beginn Neu 2021  */
        this.SOLZVBMG=this.STV.div(this.ZAHL100).round( 0, RoundingMode.RoundDown).add(this.JBMG);
  ...
  private UPTAB21() : void { /**  Änderung für 2021  */
    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) { 
        ...
        if (this.X.cmp (new Big (14754)) == -1) {/**  Geändert für 2021  */
            ...
            if (this.X.cmp (new Big (57919)) == -1) {/**  Geändert für 2021  */
                ...
                this.Y= (this.X.sub (new Big (14753))).div(this.ZAHL10000).round( 6, RoundingMode.RoundDown); /**  Geändert für 2021   */
                this.RW= this.Y.mul (new Big (208.85));/**  Geändert für 2021  */
                this.RW= this.RW.add (new Big (2397));
                this.RW= this.RW.mul (this.Y);
                this.ST= (this.RW.add (new Big (950.96))).round (0, RoundingMode.RoundDown); /**  Geändert für 2021  */
              
              }else {
	            if (this.X.cmp (new Big (274613)) == -1) {/**  Geändert für 2021  */
	              
                    this.ST= ((this.X.mul (new Big (0.42))).sub (new Big (9136.63))).round (0, RoundingMode.RoundDown); /**  Geändert für 2021  */
                  
                  }else {
                    this.ST= ((this.X.mul (new Big (0.45))).sub (new Big (17374.99))).round (0, RoundingMode.RoundDown); /**  Geändert für 2021  */

...
* 
*/
export class Lohnsteuer2015DezemberBig implements TaxJs {
    ...
    /**   INTERNE FELDER   */
       ...
       /**  Kennzahl fuer die Einkommensteuer-Tabellenart:
        ...
        private SCHLEIFZ : number = 0; /**  Neu 2015  */
        ...
        private W1STKL5 : Big = this.Z_0; /**  Neu 2015  */
        
        /**  Zweiter Grenzwert in Steuerklasse V/VI in Euro  */
        private W2STKL5 : Big = this.Z_0; /**  Neu 2015  */
        
        /**  Dritter Grenzwert in Steuerklasse V/VI in Euro  */
        private W3STKL5 : Big = this.Z_0; /**  Neu 2015  */
        ...
        private ZRE4VPM : Big = this.Z_0; /**  Neu 2015  */
  ...
  private MZTABFBA() : void { /**  Neu 2015 Nur Änderung an der Bezeichnung */
    this.ANP= this.Z_0;
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 23  */
  private MZTABFBN() : void { 
    ...
    if (this.STKL == 1) {
        ...
        this.SAP= new Big (36);
        this.KFB= (this.ZKF.mul (new Big (7152))).round (0, RoundingMode.RoundDown);
					...
					if (this.STKL == 3) {
					        ...
					        this.KFB= (this.ZKF.mul (new Big (7152))).round (0, RoundingMode.RoundDown);
						  	...
						  	if (this.STKL == 4) {
						        ...
						        this.SAP= new Big (36);
						        this.KFB= (this.ZKF.mul (new Big (3576))).round (0, RoundingMode.RoundDown);
  ...
  private MLST1215() : void {
  	 if (this.LZZ > 1) {
        
            this.JW = (this.JWLSTN.sub(new Big(11).mul((this.JWLSTA.sub(this.JWLSTN))))).round(0, RoundingMode.RoundDown);
     		...
     		this.LSTLZZ = this.ANTEIL1;
     	    this.JW = (this.JWSOLZN.sub(new Big(11).mul(this.JWSOLZA.sub(this.JWSOLZN)))).round(0, RoundingMode.RoundDown);
     		...
     		this.SOLZLZZ = this.ANTEIL1;
     	    this.JW = (this.JWBKN.sub(new Big(11).mul(this.JWBKA.sub(this.JWBKN)))).round(0, RoundingMode.RoundDown);
  ...
  private UPTAB14() : void {
    if (this.X.cmp (new Big (8355)) == -1) { 
        ...
        if (this.X.cmp (new Big (13470)) == -1) {
            ...
            this.Y= (this.X.sub (new Big (8354))).div(new Big (10000)).round( 6, RoundingMode.RoundDown); 
            ...
            if (this.X.cmp (new Big (52882)) == -1) {
                ...
                this.ST= (this.RW.add (new Big (971))).round (0, RoundingMode.RoundDown); 
              
              }else {
	            if (this.X.cmp (new Big (250731)) == -1) {
	              
                    this.ST= ((this.X.mul (new Big (0.42))).sub (new Big (8239))).round (0, RoundingMode.RoundDown); 
                  
                  }else {
                    this.ST= ((this.X.mul (new Big (0.45))).sub (new Big (15761))).round (0, RoundingMode.RoundDown); 
  ...
  private UPTAB15() : void {
    if (this.X.cmp (new Big (8473)) == -1) { 
        ...
        if (this.X.cmp (new Big (13470)) == -1) {
            ...
            this.Y= (this.X.sub (new Big (8472))).div(new Big (10000)).round( 6, RoundingMode.RoundDown); 
            ...
            if (this.X.cmp (new Big (52882)) == -1) {
                ...
                this.RW= this.RW.add (new Big (2397));
                this.RW= this.RW.mul (this.Y);
                this.ST= (this.RW.add (new Big (948.68))).round (0, RoundingMode.RoundDown); 
              
              }else {
	            if (this.X.cmp (new Big (250731)) == -1) {
	              
                    this.ST= ((this.X.mul (new Big (0.42))).sub (new Big (8261.29))).round (0, RoundingMode.RoundDown); 
                  
                  }else {
                    this.ST= ((this.X.mul (new Big (0.45))).sub (new Big (15783.19))).round (0, RoundingMode.RoundDown); 

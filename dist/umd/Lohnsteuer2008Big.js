...
(function (factory) {
    ...
    exports.Lohnsteuer2008Big = void 0;
    ...
    var Lohnsteuer2008Big = /** @class */ (function () {
        ...
        Lohnsteuer2008Big.prototype.MLSTJAHR = function () {
            ...
            if (this.KENNVMT == 0) {
                ...
                if (this.KENNVMT == 1) {
                    this.ZVE = this.ZRE4OSO.sub(this.ZTABFBOSO).add(this.ZRE4VMT).sub(this.VSP).round(2, big_js_1.default.roundDown);
                }
                else {
                    this.ZVE = (((this.ZRE4.sub(this.ZTABFB)).div(this.ZAHL5)).sub(this.VSP)).round(2, big_js_1.default.roundDown);
                }
            }
        ...
        Lohnsteuer2008Big.prototype.UPEVP = function () {
            ...
            if (this.KRV > 0) {
                ...
                this.VSP1 = (this.ZRE4VP.mul(new big_js_1.default(0.32))).round(2, big_js_1.default.roundDown);
        ...
        Lohnsteuer2008Big.prototype.MVMT = function () {
            ...
            if ((this.VMT.add(this.VKAPA)).cmp(this.Z_0) == 1) {
                ...
                this.ZTABFB = (this.ZTABFB.sub(this.FVBZ).add(this.FVBZOSO)).round(2, big_js_1.default.roundDown);
                this.KENNVMT = 1;
                if ((this.JRE4.add(this.SONSTB).sub(this.JFREIB).add(this.JHINZU)).cmp(this.Z_0) == -1) {
                    ...
                    this.ZRE4VMT = (((this.VMT.div(this.ZAHL100)).add(this.VKAPA.div(this.ZAHL100)).sub(this.ZTABFB).add(this.ZTABFBOSO)).div(this.ZAHL5)).round(2, big_js_1.default.roundDown);
                    this.MLSTJAHR();
                    this.LST2 = this.ST.mul(this.ZAHL100);

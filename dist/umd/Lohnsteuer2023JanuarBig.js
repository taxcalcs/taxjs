(function (factory) {
    ...
    exports.Lohnsteuer2023JanuarBig = void 0;
    ...
    *
    */
    var Lohnsteuer2023JanuarBig = /** @class */ (function () {
        function Lohnsteuer2023JanuarBig() {
        ...
        Lohnsteuer2023JanuarBig.prototype.calculate = function () {
            this.MPARA();
            this.MRE4JL();
            this.VBEZBSO = this.Z_0;
            this.KENNVMT = 0;
        ...
        Lohnsteuer2023JanuarBig.prototype.MPARA = function () {
            if (this.KRV < 2) { /**  &lt; = <  */
                if (this.KRV == 0) {
                    this.BBGRV = new big_js_1.default(87600); /**  Geändert für 2023  */
                }
                else {
                    this.BBGRV = new big_js_1.default(85200); /**  Geändert für 2023  */
                }
                this.RVSATZAN = new big_js_1.default(0.093); /**  Neu 2019  */
                this.TBSVORV = new big_js_1.default(1.00); /**  Geändert für 2023 */
            }
            else {
                /**  Nichts zu tun  */
            }
            this.BBGKVPV = new big_js_1.default(59850); /**  Geändert für 2023  */
            ...
            this.KVSATZAG = new big_js_1.default(0.008 + 0.07); /**  Geändert für 2023 */
            if (this.PVS == 1) {
            ...
            this.W1STKL5 = new big_js_1.default(12485);
            this.W2STKL5 = new big_js_1.default(31404);
            this.W3STKL5 = new big_js_1.default(222260);
            this.GFB = new big_js_1.default(10908);
            this.SOLZFREI = new big_js_1.default(17543);
            /**  Ende Geändert für 2023  */
        };
        /**  Ermittlung des Jahresarbeitslohns nach § 39 b Abs. 2 Satz 2 EStG, PAP Seite 16  */
        Lohnsteuer2023JanuarBig.prototype.MRE4JL = function () {
            if (this.LZZ == 1) {
        ...
        Lohnsteuer2023JanuarBig.prototype.MRE4 = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MRE4ALTE = function () {
            if (this.ALTER1 == 0) {
                this.ALTE = this.Z_0;
            }
            else {
        ...
        Lohnsteuer2023JanuarBig.prototype.MRE4ABZ = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MBERECH = function () {
            this.MZTABFB();
        ...
        Lohnsteuer2023JanuarBig.prototype.MZTABFB = function () {
            this.ANP = this.Z_0;
            ...
            if (this.STKL == 1) {
                ...
                this.KFB = (this.ZKF.mul(new big_js_1.default(8952))).round(0, big_js_1.default.roundDown); /**  Geändert für 2023  */
            }
            else {
                if (this.STKL == 2) {
                    ...
                    if (this.STKL == 3) {
                        ...
                        if (this.STKL == 4) {
                            this.SAP = new big_js_1.default(36);
                            this.KFB = (this.ZKF.mul(new big_js_1.default(4476))).round(0, big_js_1.default.roundDown); /**  Geändert für 2023  */
                        }
                        else {
                            if (this.STKL == 5) {
                                this.SAP = new big_js_1.default(36);
        ...
        Lohnsteuer2023JanuarBig.prototype.MLSTJAHR = function () {
            this.UPEVP();
            if (this.KENNVMT != 1) {
        ...
        /**  PAP Seite 24  */
        Lohnsteuer2023JanuarBig.prototype.UPVKVLZZ = function () {
            this.UPVKV();
            this.JW = this.VKV;
            this.UPANTEIL();
        ...
        /**  PAP Seite 24  */
        Lohnsteuer2023JanuarBig.prototype.UPVKV = function () {
            if (this.PKV > 0) {
        ...
        /**  PAP Seite 25  */
        Lohnsteuer2023JanuarBig.prototype.UPLSTLZZ = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.UPMLST = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.UPEVP = function () {
            if (this.KRV > 1) { /**  &lt; = < &gt; = >  */
                this.VSP1 = this.Z_0;
            }
            else {
        ...
        Lohnsteuer2023JanuarBig.prototype.MVSP = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MST5_6 = function () {
            this.ZZX = this.X;
        ...
        Lohnsteuer2023JanuarBig.prototype.UP5_6 = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MSOLZ = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.UPANTEIL = function () {
            if (this.LZZ == 1) {
        ...
        Lohnsteuer2023JanuarBig.prototype.MSONST = function () {
            this.LZZ = 1;
            if (this.ZMVB == 0) {
                this.ZMVB = 12;
            }
        ...
        Lohnsteuer2023JanuarBig.prototype.STSMIN = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MSOLZSTS = function () {
            if (this.ZKF.cmp(this.Z_0) == 1) { /**  ZKF > 0  */
        ...
        Lohnsteuer2023JanuarBig.prototype.MVMT = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MOSONST = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.MRE4SONST = function () {
            this.MRE4();
            this.FVB = this.FVBSO;
            this.MRE4ABZ();
            /**  Änderung für 2022   */
        ...
        Lohnsteuer2023JanuarBig.prototype.UPTAB23 = function () {
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                this.ST = this.Z_0;
            }
            else {
                if (this.X.cmp(new big_js_1.default(16000)) == -1) { /**  Geändert für 2023  */
                    this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                    this.RW = this.Y.mul(new big_js_1.default(979.18)); /**  Geändert für 2023  */
                    this.RW = this.RW.add(new big_js_1.default(1400));
                    this.ST = (this.RW.mul(this.Y)).round(0, big_js_1.default.roundDown);
                }
                else {
                    if (this.X.cmp(new big_js_1.default(62810)) == -1) { /**  Geändert für 2023  */
                        this.Y = (this.X.sub(new big_js_1.default(15999))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown); /**  Geändert für 2023   */
                        this.RW = this.Y.mul(new big_js_1.default(192.59)); /**  Geändert für 2023  */
                        this.RW = this.RW.add(new big_js_1.default(2397));
                        this.RW = this.RW.mul(this.Y);
                        this.ST = (this.RW.add(new big_js_1.default(966.53))).round(0, big_js_1.default.roundDown); /**  Geändert für 2023  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(277826)) == -1) { /**  Geändert für 2022  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(9972.98))).round(0, big_js_1.default.roundDown); /**  Geändert für 2023  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(18307.73))).round(0, big_js_1.default.roundDown); /**  Geändert für 2023  */
                        }
                    }
                }
            }
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getAf = function () {
            return this.af;
        };
        /**
         * Setter for af.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setAf = function (af) {
            this.af = af;
        };
        /**
         * Getter for AJAHR.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getAJAHR = function () {
            return this.AJAHR;
        };
        /**
         * Setter for AJAHR.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setAJAHR = function (AJAHR) {
            this.AJAHR = AJAHR;
        };
        /**
         * Getter for ALTER1.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getALTER1 = function () {
            return this.ALTER1;
        };
        /**
         * Setter for ALTER1.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setALTER1 = function (ALTER1) {
            this.ALTER1 = ALTER1;
        };
        /**
         * Getter for ENTSCH.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getENTSCH = function () {
            return this.ENTSCH;
        };
        /**
         * Setter for ENTSCH.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setENTSCH = function (ENTSCH) {
            this.ENTSCH = ENTSCH;
        };
        /**
         * Getter for f.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getF = function () {
            return this.f;
        };
        /**
         * Setter for f.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setF = function (f) {
            this.f = f;
        };
        /**
         * Getter for JFREIB.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getJFREIB = function () {
            return this.JFREIB;
        };
        /**
         * Setter for JFREIB.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setJFREIB = function (JFREIB) {
            this.JFREIB = JFREIB;
        };
        /**
         * Getter for JHINZU.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getJHINZU = function () {
            return this.JHINZU;
        };
        /**
         * Setter for JHINZU.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setJHINZU = function (JHINZU) {
            this.JHINZU = JHINZU;
        };
        /**
         * Getter for JRE4.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getJRE4 = function () {
            return this.JRE4;
        };
        /**
         * Setter for JRE4.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setJRE4 = function (JRE4) {
            this.JRE4 = JRE4;
        };
        /**
         * Getter for JVBEZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getJVBEZ = function () {
            return this.JVBEZ;
        };
        /**
         * Setter for JVBEZ.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setJVBEZ = function (JVBEZ) {
            this.JVBEZ = JVBEZ;
        };
        /**
         * Getter for KRV.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getKRV = function () {
            return this.KRV;
        };
        /**
         * Setter for KRV.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setKRV = function (KRV) {
            this.KRV = KRV;
        };
        /**
         * Getter for KVZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getKVZ = function () {
            return this.KVZ;
        };
        /**
         * Setter for KVZ.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setKVZ = function (KVZ) {
            this.KVZ = KVZ;
        };
        /**
         * Getter for LZZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getLZZ = function () {
            return this.LZZ;
        };
        /**
         * Setter for LZZ.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setLZZ = function (LZZ) {
            this.LZZ = LZZ;
        };
        /**
         * Getter for LZZFREIB.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getLZZFREIB = function () {
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setLZZFREIB = function (LZZFREIB) {
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getLZZHINZU = function () {
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setLZZHINZU = function (LZZHINZU) {
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getMBV = function () {
            return this.MBV;
        };
        /**
         * Setter for MBV.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setMBV = function (MBV) {
            this.MBV = MBV;
        };
        /**
         * Getter for PKPV.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getPKPV = function () {
            return this.PKPV;
        };
        /**
         * Setter for PKPV.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setPKPV = function (PKPV) {
            this.PKPV = PKPV;
        };
        /**
         * Getter for PKV.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getPKV = function () {
            return this.PKV;
        };
        /**
         * Setter for PKV.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setPKV = function (PKV) {
            this.PKV = PKV;
        };
        /**
         * Getter for PVS.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getPVS = function () {
            return this.PVS;
        };
        /**
         * Setter for PVS.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setPVS = function (PVS) {
            this.PVS = PVS;
        };
        /**
         * Getter for PVZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getPVZ = function () {
            return this.PVZ;
        };
        /**
         * Setter for PVZ.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setPVZ = function (PVZ) {
            this.PVZ = PVZ;
        };
        /**
         * Getter for R.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getR = function () {
            return this.R;
        };
        /**
         * Setter for R.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setR = function (R) {
            this.R = R;
        };
        /**
         * Getter for RE4.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getRE4 = function () {
            return this.RE4;
        };
        /**
         * Setter for RE4.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setRE4 = function (RE4) {
            this.RE4 = RE4;
        };
        /**
         * Getter for SONSTB.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSONSTB = function () {
            return this.SONSTB;
        };
        /**
         * Setter for SONSTB.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setSONSTB = function (SONSTB) {
            this.SONSTB = SONSTB;
        };
        /**
         * Getter for STERBE.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSTERBE = function () {
            return this.STERBE;
        };
        /**
         * Setter for STERBE.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setSTERBE = function (STERBE) {
            this.STERBE = STERBE;
        };
        /**
         * Getter for STKL.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSTKL = function () {
            return this.STKL;
        };
        /**
         * Setter for STKL.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setSTKL = function (STKL) {
            this.STKL = STKL;
        };
        /**
         * Getter for VBEZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVBEZ = function () {
            return this.VBEZ;
        };
        /**
         * Setter for VBEZ.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVBEZ = function (VBEZ) {
            this.VBEZ = VBEZ;
        };
        /**
         * Getter for VBEZM.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVBEZM = function () {
            return this.VBEZM;
        };
        /**
         * Setter for VBEZM.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVBEZM = function (VBEZM) {
            this.VBEZM = VBEZM;
        };
        /**
         * Getter for VBEZS.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVBEZS = function () {
            return this.VBEZS;
        };
        /**
         * Setter for VBEZS.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVBEZS = function (VBEZS) {
            this.VBEZS = VBEZS;
        };
        /**
         * Getter for VBS.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVBS = function () {
            return this.VBS;
        };
        /**
         * Setter for VBS.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVBS = function (VBS) {
            this.VBS = VBS;
        };
        /**
         * Getter for VJAHR.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVJAHR = function () {
            return this.VJAHR;
        };
        /**
         * Setter for VJAHR.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVJAHR = function (VJAHR) {
            this.VJAHR = VJAHR;
        };
        /**
         * Getter for VKAPA.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVKAPA = function () {
            return this.VKAPA;
        };
        /**
         * Setter for VKAPA.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVKAPA = function (VKAPA) {
            this.VKAPA = VKAPA;
        };
        /**
         * Getter for VMT.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVMT = function () {
            return this.VMT;
        };
        /**
         * Setter for VMT.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setVMT = function (VMT) {
            this.VMT = VMT;
        };
        /**
         * Getter for ZKF.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getZKF = function () {
            return this.ZKF;
        };
        /**
         * Setter for ZKF.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setZKF = function (ZKF) {
            this.ZKF = ZKF;
        };
        /**
         * Getter for ZMVB.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getZMVB = function () {
            return this.ZMVB;
        };
        /**
         * Setter for ZMVB.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setZMVB = function (ZMVB) {
            this.ZMVB = ZMVB;
        };
        /**
         * Getter for JRE4ENT.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getJRE4ENT = function () {
            return this.JRE4ENT;
        };
        /**
         * Setter for JRE4ENT.
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setJRE4ENT = function (JRE4ENT) {
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSONSTENT = function () {
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.setSONSTENT = function (SONSTENT) {
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getBK = function () {
            return this.BK;
        };
        /**
         * Getter for BKS.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getBKS = function () {
            return this.BKS;
        };
        /**
         * Getter for BKV.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getBKV = function () {
            return this.BKV;
        };
        /**
         * Getter for LSTLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getLSTLZZ = function () {
            return this.LSTLZZ;
        };
        /**
         * Getter for SOLZLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSOLZLZZ = function () {
            return this.SOLZLZZ;
        };
        /**
         * Getter for SOLZS.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSOLZS = function () {
            return this.SOLZS;
        };
        /**
         * Getter for SOLZV.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSOLZV = function () {
            return this.SOLZV;
        };
        /**
         * Getter for STS.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSTS = function () {
            return this.STS;
        };
        /**
         * Getter for STV.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getSTV = function () {
            return this.STV;
        };
        /**
         * Getter for VKVLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVKVLZZ = function () {
            return this.VKVLZZ;
        };
        /**
         * Getter for VKVSONST.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVKVSONST = function () {
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVFRB = function () {
            return this.VFRB;
        };
        /**
         * Getter for VFRBS1.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVFRBS1 = function () {
            return this.VFRBS1;
        };
        /**
         * Getter for VFRBS2.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getVFRBS2 = function () {
            return this.VFRBS2;
        };
        /**
         * Getter for WVFRB.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getWVFRB = function () {
            return this.WVFRB;
        };
        /**
         * Getter for WVFRBO.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getWVFRBO = function () {
            return this.WVFRBO;
        };
        /**
         * Getter for WVFRBM.
         ...
         * @return the value
         */
        Lohnsteuer2023JanuarBig.prototype.getWVFRBM = function () {
            return this.WVFRBM;
        };
        /**
         * Initialize all inputs values with zero.
         */
        Lohnsteuer2023JanuarBig.prototype.initInputs = function () {
        ...
        Lohnsteuer2023JanuarBig.prototype.isBigInput = function (name, value) {
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.set = function (name, value) {
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.get = function (name) {
            if (this.hasOwnProperty(name)) {
                return this[name];
            }
            throw new Error("Unknown parameter " + name);
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.getDirectory = function () {
            return Lohnsteuer2023JanuarBig.typeDirectory;
        };
        /**
         ...
         */
        Lohnsteuer2023JanuarBig.prototype.toType = function (name, value) {
            var info = Lohnsteuer2023JanuarBig.typeDirectory[name];
            if (!info) {
                throw new Error("Unknown parameter " + name);
            }
        ...
        Lohnsteuer2023JanuarBig._n = "number";
        Lohnsteuer2023JanuarBig._b = "Big";
        Lohnsteuer2023JanuarBig._i = "input";
        Lohnsteuer2023JanuarBig._o = "output";
        Lohnsteuer2023JanuarBig._s = "STANDARD";
        Lohnsteuer2023JanuarBig._d = "DBA";
        Lohnsteuer2023JanuarBig.typeDirectory = {
            "af": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "AJAHR": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "ALTER1": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "ENTSCH": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "f": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "JFREIB": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "JHINZU": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "JRE4": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "JVBEZ": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "KRV": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "KVZ": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "LZZ": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "LZZFREIB": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "LZZHINZU": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "MBV": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "PKPV": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "PKV": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "PVS": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "PVZ": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "R": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "RE4": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "SONSTB": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "STERBE": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "STKL": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "VBEZ": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "VBEZM": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "VBEZS": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "VBS": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "VJAHR": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "VKAPA": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "VMT": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "ZKF": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "ZMVB": { type: Lohnsteuer2023JanuarBig._n, direction: Lohnsteuer2023JanuarBig._i }, "JRE4ENT": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "SONSTENT": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._i }, "BK": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "BKS": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "BKV": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "LSTLZZ": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "SOLZLZZ": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "SOLZS": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "SOLZV": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "STS": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "STV": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "VKVLZZ": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "VKVSONST": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._s }, "VFRB": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._d }, "VFRBS1": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._d }, "VFRBS2": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._d }, "WVFRB": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._d }, "WVFRBO": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._d }, "WVFRBM": { type: Lohnsteuer2023JanuarBig._b, direction: Lohnsteuer2023JanuarBig._o, group: Lohnsteuer2023JanuarBig._d },
        };
        return Lohnsteuer2023JanuarBig;
    }());
    exports.Lohnsteuer2023JanuarBig = Lohnsteuer2023JanuarBig;
});
//# sourceMappingURL=Lohnsteuer2023JanuarBig.js.map
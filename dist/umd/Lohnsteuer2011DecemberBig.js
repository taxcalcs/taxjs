(function (factory) {
    ...
    exports.Lohnsteuer2011DecemberBig = void 0;
    ...
    *
    */
    var Lohnsteuer2011DecemberBig = /** @class */ (function () {
        function Lohnsteuer2011DecemberBig() {
        ...
        Lohnsteuer2011DecemberBig.prototype.calculate = function () {
            this.MRE4JL();
            this.VBEZBSO = this.Z_0;
            this.KENNVMT = 0;
            this.MRE4();
        ...
        Lohnsteuer2011DecemberBig.prototype.UPANP12 = function () {
            if (this.LZZ == 1) {
                if ((this.ZRE4.sub(this.ZVBEZ)).cmp(new big_js_1.default(1000)) == -1) {
                    this.ANP = ((this.ANP.add(this.ZRE4)).sub(this.ZVBEZ)).round(0, 3 /* RoundUp */);
                }
                else {
                    this.ANP = this.ANP.add(new big_js_1.default(1000));
                }
            }
            else {
                if ((this.ZRE4.sub(this.ZVBEZ)).cmp(new big_js_1.default(1880)) == -1) {
                    this.ANP = ((this.ANP.add(this.ZRE4)).sub(this.ZVBEZ)).round(0, 3 /* RoundUp */);
                    ;
                }
                else {
                    this.ANP = this.ANP.add(new big_js_1.default(1880));
                }
            }
        };
        /**  Ermittlung des Jahresarbeitslohns nach § 39 b Abs. 2 Satz 2 EStG, PAP Seite 11  */
        Lohnsteuer2011DecemberBig.prototype.MRE4JL = function () {
            if (this.LZZ == 1) {
        ...
        Lohnsteuer2011DecemberBig.prototype.MRE4 = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.MRE4ALTE = function () {
            if (this.ALTER1 == 0) {
                this.ALTE = this.Z_0;
            }
            else {
        ...
        Lohnsteuer2011DecemberBig.prototype.MRE4ABZ = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.MZTABFB = function () {
            this.ANP = this.Z_0;
        ...
        Lohnsteuer2011DecemberBig.prototype.MLSTJAHR = function () {
            this.UPEVP();
            if (this.KENNVMT != 1) {
        ...
        Lohnsteuer2011DecemberBig.prototype.UPMLST = function () {
        ...
        /**  	Vorsorgepauschale (§ 39b Abs. 2 Satz 5 Nr 3 EStG) nach dem Bürgerentlastungsgesetz Krankenversicherung
                  ...
                  PAP Seite 19   */
        Lohnsteuer2011DecemberBig.prototype.UPEVP = function () {
            if (this.KRV > 1) {
                this.VSP1 = this.Z_0;
            }
            else {
                ...
                this.VSP1 = (this.ZRE4VP.mul(new big_js_1.default(0.44))).round(2, 0 /* RoundDown */);
        ...
        Lohnsteuer2011DecemberBig.prototype.MVSP = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.UMVSP = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.MST5_6 = function () {
            this.ZZX = this.X;
        ...
        Lohnsteuer2011DecemberBig.prototype.UP5_6 = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.MSOLZ = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.UPANTEIL = function () {
            if (this.LZZ == 1) {
        ...
        Lohnsteuer2011DecemberBig.prototype.MSONST = function () {
            this.LZZ = 1;
            if (this.ZMVB == 0) {
                this.ZMVB = 12;
            }
        ...
        Lohnsteuer2011DecemberBig.prototype.MVMT = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.MOSONST = function () {
        ...
        Lohnsteuer2011DecemberBig.prototype.MRE4SONST = function () {
            this.MRE4();
            this.FVB = this.FVBSO;
            this.MRE4ABZ();
            this.ZRE4VP = this.ZRE4VP.sub(this.JRE4ENT.div(this.ZAHL100)).sub(this.SONSTENT.div(this.ZAHL100));
        ...
        Lohnsteuer2011DecemberBig.prototype.UPTAB10 = function () {
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getAf = function () {
            return this.af;
        };
        /**
         * Setter for af.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setAf = function (af) {
            this.af = af;
        };
        /**
         * Getter for AJAHR.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getAJAHR = function () {
            return this.AJAHR;
        };
        /**
         * Setter for AJAHR.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setAJAHR = function (AJAHR) {
            this.AJAHR = AJAHR;
        };
        /**
         * Getter for ALTER1.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getALTER1 = function () {
            return this.ALTER1;
        };
        /**
         * Setter for ALTER1.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setALTER1 = function (ALTER1) {
            this.ALTER1 = ALTER1;
        };
        /**
         * Getter for ENTSCH.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getENTSCH = function () {
            return this.ENTSCH;
        };
        /**
         * Setter for ENTSCH.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setENTSCH = function (ENTSCH) {
            this.ENTSCH = ENTSCH;
        };
        /**
         * Getter for f.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getF = function () {
            return this.f;
        };
        /**
         * Setter for f.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setF = function (f) {
            this.f = f;
        };
        /**
         * Getter for JFREIB.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getJFREIB = function () {
            return this.JFREIB;
        };
        /**
         * Setter for JFREIB.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setJFREIB = function (JFREIB) {
            this.JFREIB = JFREIB;
        };
        /**
         * Getter for JHINZU.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getJHINZU = function () {
            return this.JHINZU;
        };
        /**
         * Setter for JHINZU.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setJHINZU = function (JHINZU) {
            this.JHINZU = JHINZU;
        };
        /**
         * Getter for JRE4.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getJRE4 = function () {
            return this.JRE4;
        };
        /**
         * Setter for JRE4.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setJRE4 = function (JRE4) {
            this.JRE4 = JRE4;
        };
        /**
         * Getter for JVBEZ.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getJVBEZ = function () {
            return this.JVBEZ;
        };
        /**
         * Setter for JVBEZ.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setJVBEZ = function (JVBEZ) {
            this.JVBEZ = JVBEZ;
        };
        /**
         * Getter for KRV.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getKRV = function () {
            return this.KRV;
        };
        /**
         * Setter for KRV.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setKRV = function (KRV) {
            this.KRV = KRV;
        };
        /**
         * Getter for LZZ.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getLZZ = function () {
            return this.LZZ;
        };
        /**
         * Setter for LZZ.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setLZZ = function (LZZ) {
            this.LZZ = LZZ;
        };
        /**
         * Getter for LZZFREIB.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getLZZFREIB = function () {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setLZZFREIB = function (LZZFREIB) {
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getLZZHINZU = function () {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setLZZHINZU = function (LZZHINZU) {
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getPKPV = function () {
            return this.PKPV;
        };
        /**
         * Setter for PKPV.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setPKPV = function (PKPV) {
            this.PKPV = PKPV;
        };
        /**
         * Getter for PKV.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getPKV = function () {
            return this.PKV;
        };
        /**
         * Setter for PKV.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setPKV = function (PKV) {
            this.PKV = PKV;
        };
        /**
         * Getter for PVS.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getPVS = function () {
            return this.PVS;
        };
        /**
         * Setter for PVS.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setPVS = function (PVS) {
            this.PVS = PVS;
        };
        /**
         * Getter for PVZ.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getPVZ = function () {
            return this.PVZ;
        };
        /**
         * Setter for PVZ.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setPVZ = function (PVZ) {
            this.PVZ = PVZ;
        };
        /**
         * Getter for R.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getR = function () {
            return this.R;
        };
        /**
         * Setter for R.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setR = function (R) {
            this.R = R;
        };
        /**
         * Getter for RE4.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getRE4 = function () {
            return this.RE4;
        };
        /**
         * Setter for RE4.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setRE4 = function (RE4) {
            this.RE4 = RE4;
        };
        /**
         * Getter for SONSTB.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSONSTB = function () {
            return this.SONSTB;
        };
        /**
         * Setter for SONSTB.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setSONSTB = function (SONSTB) {
            this.SONSTB = SONSTB;
        };
        /**
         * Getter for STERBE.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSTERBE = function () {
            return this.STERBE;
        };
        /**
         * Setter for STERBE.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setSTERBE = function (STERBE) {
            this.STERBE = STERBE;
        };
        /**
         * Getter for STKL.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSTKL = function () {
            return this.STKL;
        };
        /**
         * Setter for STKL.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setSTKL = function (STKL) {
            this.STKL = STKL;
        };
        /**
         * Getter for VBEZ.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVBEZ = function () {
            return this.VBEZ;
        };
        /**
         * Setter for VBEZ.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVBEZ = function (VBEZ) {
            this.VBEZ = VBEZ;
        };
        /**
         * Getter for VBEZM.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVBEZM = function () {
            return this.VBEZM;
        };
        /**
         * Setter for VBEZM.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVBEZM = function (VBEZM) {
            this.VBEZM = VBEZM;
        };
        /**
         * Getter for VBEZS.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVBEZS = function () {
            return this.VBEZS;
        };
        /**
         * Setter for VBEZS.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVBEZS = function (VBEZS) {
            this.VBEZS = VBEZS;
        };
        /**
         * Getter for VBS.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVBS = function () {
            return this.VBS;
        };
        /**
         * Setter for VBS.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVBS = function (VBS) {
            this.VBS = VBS;
        };
        /**
         * Getter for VJAHR.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVJAHR = function () {
            return this.VJAHR;
        };
        /**
         * Setter for VJAHR.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVJAHR = function (VJAHR) {
            this.VJAHR = VJAHR;
        };
        /**
         * Getter for VKAPA.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVKAPA = function () {
            return this.VKAPA;
        };
        /**
         * Setter for VKAPA.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVKAPA = function (VKAPA) {
            this.VKAPA = VKAPA;
        };
        /**
         * Getter for VMT.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getVMT = function () {
            return this.VMT;
        };
        /**
         * Setter for VMT.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setVMT = function (VMT) {
            this.VMT = VMT;
        };
        /**
         * Getter for ZKF.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getZKF = function () {
            return this.ZKF;
        };
        /**
         * Setter for ZKF.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setZKF = function (ZKF) {
            this.ZKF = ZKF;
        };
        /**
         * Getter for ZMVB.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getZMVB = function () {
            return this.ZMVB;
        };
        /**
         * Setter for ZMVB.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setZMVB = function (ZMVB) {
            this.ZMVB = ZMVB;
        };
        /**
         * Getter for JRE4ENT.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getJRE4ENT = function () {
            return this.JRE4ENT;
        };
        /**
         * Setter for JRE4ENT.
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setJRE4ENT = function (JRE4ENT) {
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSONSTENT = function () {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setSONSTENT = function (SONSTENT) {
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getBK = function () {
            return this.BK;
        };
        /**
         * Getter for BKS.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getBKS = function () {
            return this.BKS;
        };
        /**
         * Getter for BKV.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getBKV = function () {
            return this.BKV;
        };
        /**
         * Getter for LSTLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getLSTLZZ = function () {
            return this.LSTLZZ;
        };
        /**
         * Getter for SOLZLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSOLZLZZ = function () {
            return this.SOLZLZZ;
        };
        /**
         * Getter for SOLZS.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSOLZS = function () {
            return this.SOLZS;
        };
        /**
         * Getter for SOLZV.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSOLZV = function () {
            return this.SOLZV;
        };
        /**
         * Getter for STS.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSTS = function () {
            return this.STS;
        };
        /**
         * Getter for STV.
         ...
         * @return the value
         */
        Lohnsteuer2011DecemberBig.prototype.getSTV = function () {
            return this.STV;
        };
        /**
         * Initialize all inputs values with zero.
         */
        Lohnsteuer2011DecemberBig.prototype.initInputs = function () {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setBig = function (name, value) {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.setNumber = function (name, value) {
            if (this.hasOwnProperty(name)) {
                this[name] = value;
            }
            else {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.get = function (name) {
            if (this.hasOwnProperty(name)) {
                return this[name];
            }
            throw new Error("Unknown parameter " + name);
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.getDirectory = function () {
         ...
         */
        Lohnsteuer2011DecemberBig.prototype.toType = function (name, value) {
            var info = Lohnsteuer2011DecemberBig.typeDirectory[name];
            if (!info) {
                throw new Error("Unknown parameter " + name);
            }

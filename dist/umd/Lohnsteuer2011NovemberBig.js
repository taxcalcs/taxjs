(function (factory) {
    ...
    */
    var Lohnsteuer2011NovemberBig = /** @class */ (function () {
         ...
         */
        Lohnsteuer2011NovemberBig.prototype.getBig = function (name) {
            switch (name) {
         ...
         * @param {String} name Variable name to get.
         */
        Lohnsteuer2011NovemberBig.prototype.getNumber = function (name) {
            switch (name) {
                default:
                    throw new Error("Unknown number parameter " + name);
            }
         ...
         * Get all input names.
         */
        Lohnsteuer2011NovemberBig.prototype.getInputs = function () {
            return [
         ...
         */
        Lohnsteuer2011NovemberBig.prototype.getOutputs = function () {
            return [

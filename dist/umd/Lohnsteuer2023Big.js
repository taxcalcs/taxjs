    ...
    var Lohnsteuer2023Big = /** @class */ (function () {
        ...
        Lohnsteuer2023Big.prototype.MZTABFB = function () {
            ...
            if (this.STKL == 1) {
                ...
                this.KFB = (this.ZKF.mul(new big_js_1.default(8952))).round(0, 0 /* RoundDown */); /**  Geändert für 2023  */
            }
            else {
                if (this.STKL == 2) {
                    ...
                    if (this.STKL == 3) {
                        ...
                        if (this.STKL == 4) {
                            this.SAP = new big_js_1.default(36);
                            this.KFB = (this.ZKF.mul(new big_js_1.default(4476))).round(0, 0 /* RoundDown */); /**  Geändert für 2023  */
                        }
                        else {
                            if (this.STKL == 5) {
                                this.SAP = new big_js_1.default(36);
            ...
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                ...
                if (this.X.cmp(new big_js_1.default(16000)) == -1) { /**  Geändert für 2023  */
                    ...
                    if (this.X.cmp(new big_js_1.default(62810)) == -1) { /**  Geändert für 2023  */
                        this.Y = (this.X.sub(new big_js_1.default(15999))).div(this.ZAHL10000).round(6, 0 /* RoundDown */); /**  Geändert für 2023   */
                        ...
                        this.ST = (this.RW.add(new big_js_1.default(966.53))).round(0, 0 /* RoundDown */); /**  Geändert für 2023  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(277826)) == -1) { /**  Geändert für 2022  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(9972.98))).round(0, 0 /* RoundDown */); /**  Geändert für 2023  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(18307.73))).round(0, 0 /* RoundDown */); /**  Geändert für 2023  */
                        }
                    }
                }
            }

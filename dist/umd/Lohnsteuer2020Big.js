    ...
    var Lohnsteuer2020Big = /** @class */ (function () {
        ...
        Lohnsteuer2020Big.prototype.MZTABFB = function () {
            ...
            if (this.STKL == 1) {
                ...
                this.KFB = (this.ZKF.mul(new big_js_1.default(7812))).round(0, big_js_1.default.roundDown); /**  Neu 2020  */
            }
            else {
                if (this.STKL == 2) {
                    ...
                    if (this.STKL == 3) {
                        ...
                        if (this.STKL == 4) {
                            this.SAP = new big_js_1.default(36);
                            this.KFB = (this.ZKF.mul(new big_js_1.default(3906))).round(0, big_js_1.default.roundDown); /**  Neu 2020  */
                        }
                        else {
                            if (this.STKL == 5) {
                                this.SAP = new big_js_1.default(36);
            ...
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                ...
                if (this.X.cmp(new big_js_1.default(14533)) == -1) { /**  neu seit 2020  */
                    ...
                    if (this.X.cmp(new big_js_1.default(57052)) == -1) { /**  neu seit 2020  */
                        this.Y = (this.X.sub(new big_js_1.default(14532))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                        ...
                        this.ST = (this.RW.add(new big_js_1.default(972.79))).round(0, big_js_1.default.roundDown); /**  neu seit 2020  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(270501)) == -1) { /**  neu seit 2020  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8963.74))).round(0, big_js_1.default.roundDown); /**  neu seit 2020  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(17078.74))).round(0, big_js_1.default.roundDown); /**  neu seit 2020  */
                        }
                    }
                }
            }
        ...
        Lohnsteuer2020Big.prototype.isBigInput = function (name, value) {
         ...
         */
        Lohnsteuer2020Big.prototype.set = function (name, value) {

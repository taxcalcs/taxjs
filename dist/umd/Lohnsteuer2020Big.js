(function (factory) {
    ...
    */
    var Lohnsteuer2020Big = /** @class */ (function () {
         ...
         */
        Lohnsteuer2020Big.prototype.getBig = function (name) {
            switch (name) {
         ...
         * @param {String} name Variable name to get.
         */
        Lohnsteuer2020Big.prototype.getNumber = function (name) {
            switch (name) {
                default:
                    throw new Error("Unknown number parameter " + name);
            }
         ...
         * Get all input names.
         */
        Lohnsteuer2020Big.prototype.getInputs = function () {
            return [
         ...
         */
        Lohnsteuer2020Big.prototype.getOutputs = function () {
            return [

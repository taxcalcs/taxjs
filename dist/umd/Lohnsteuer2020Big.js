(function (factory) {
    ...
    exports.Lohnsteuer2020Big = void 0;
    ...
    *
    */
    var Lohnsteuer2020Big = /** @class */ (function () {
        function Lohnsteuer2020Big() {
        ...
        Lohnsteuer2020Big.prototype.calculate = function () {
            this.MPARA();
            this.MRE4JL();
            this.VBEZBSO = this.Z_0;
            this.KENNVMT = 0;
        ...
        Lohnsteuer2020Big.prototype.MPARA = function () {
            if (this.KRV < 2) { /**  &lt; = <  */
                if (this.KRV == 0) {
                    this.BBGRV = new big_js_1.default(82800); /**  Neu 2020  */
                }
                else {
                    this.BBGRV = new big_js_1.default(77400); /**  Neu 2020  */
                }
                this.RVSATZAN = new big_js_1.default(0.093); /**  Neu 2019  */
                this.TBSVORV = new big_js_1.default(0.8); /**  Neu 2020  */
            }
            else {
                /**  Nichts zu tun  */
            }
            this.BBGKVPV = new big_js_1.default(56250); /**  Neu 2020  */
            ...
            this.KVSATZAG = new big_js_1.default(0.0055 + 0.07); /**  Neu 2020  */
            if (this.PVS == 1) {
            ...
            /**  Anfang Neu 2020  */
            this.W1STKL5 = new big_js_1.default(10898);
            this.W2STKL5 = new big_js_1.default(28526);
            this.W3STKL5 = new big_js_1.default(216400);
            this.GFB = new big_js_1.default(9408);
            /**  Ende Neu 2020  */
            this.SOLZFREI = new big_js_1.default(972);
        };
        /**  Ermittlung des Jahresarbeitslohns nach § 39 b Abs. 2 Satz 2 EStG, PAP Seite 15  */
        Lohnsteuer2020Big.prototype.MRE4JL = function () {
            if (this.LZZ == 1) {
        ...
        Lohnsteuer2020Big.prototype.MRE4 = function () {
        ...
        Lohnsteuer2020Big.prototype.MRE4ALTE = function () {
            if (this.ALTER1 == 0) {
                this.ALTE = this.Z_0;
            }
            else {
        ...
        Lohnsteuer2020Big.prototype.MRE4ABZ = function () {
        ...
        Lohnsteuer2020Big.prototype.MBERECH = function () {
            this.MZTABFB();
        ...
        Lohnsteuer2020Big.prototype.MZTABFB = function () {
            this.ANP = this.Z_0;
            ...
            if (this.STKL == 1) {
                ...
                this.KFB = (this.ZKF.mul(new big_js_1.default(7812))).round(0, 0 /* RoundDown */); /**  Neu 2020  */
            }
            else {
                if (this.STKL == 2) {
                    ...
                    if (this.STKL == 3) {
                        ...
                        if (this.STKL == 4) {
                            this.SAP = new big_js_1.default(36);
                            this.KFB = (this.ZKF.mul(new big_js_1.default(3906))).round(0, 0 /* RoundDown */); /**  Neu 2020  */
                        }
                        else {
                            if (this.STKL == 5) {
                                this.SAP = new big_js_1.default(36);
        ...
        Lohnsteuer2020Big.prototype.MLSTJAHR = function () {
            this.UPEVP();
            if (this.KENNVMT != 1) {
        ...
        /**  PAP Seite 23  */
        Lohnsteuer2020Big.prototype.UPVKVLZZ = function () {
            this.UPVKV();
            this.JW = this.VKV;
            this.UPANTEIL();
        ...
        /**  PAP Seite 23  */
        Lohnsteuer2020Big.prototype.UPVKV = function () {
            if (this.PKV > 0) {
        ...
        /**  PAP Seite 24  */
        Lohnsteuer2020Big.prototype.UPLSTLZZ = function () {
        ...
        Lohnsteuer2020Big.prototype.UPMLST = function () {
        ...
        /**  	Vorsorgepauschale (§ 39b Absatz 2 Satz 5 Nummer 3 und Absatz 4 EStG)
                  ...
                  PAP Seite 26   */
        Lohnsteuer2020Big.prototype.UPEVP = function () {
            if (this.KRV > 1) { /**  &lt; = < &gt; = >  */
                this.VSP1 = this.Z_0;
            }
            else {
        ...
        Lohnsteuer2020Big.prototype.MVSP = function () {
        ...
        Lohnsteuer2020Big.prototype.MST5_6 = function () {
            this.ZZX = this.X;
        ...
        Lohnsteuer2020Big.prototype.UP5_6 = function () {
        ...
        Lohnsteuer2020Big.prototype.MSOLZ = function () {
        ...
        Lohnsteuer2020Big.prototype.UPANTEIL = function () {
            if (this.LZZ == 1) {
        ...
        Lohnsteuer2020Big.prototype.MSONST = function () {
            this.LZZ = 1;
            if (this.ZMVB == 0) {
                this.ZMVB = 12;
            }
        ...
        Lohnsteuer2020Big.prototype.MVMT = function () {
        ...
        Lohnsteuer2020Big.prototype.MOSONST = function () {
        ...
        Lohnsteuer2020Big.prototype.MRE4SONST = function () {
            this.MRE4();
            this.FVB = this.FVBSO;
            this.MRE4ABZ();
            this.ZRE4VP = this.ZRE4VP.sub(this.JRE4ENT.div(this.ZAHL100)).sub(this.SONSTENT.div(this.ZAHL100));
        ...
        Lohnsteuer2020Big.prototype.UPTAB20 = function () {
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                this.ST = this.Z_0;
            }
            else {
                if (this.X.cmp(new big_js_1.default(14533)) == -1) { /**  neu seit 2020  */
                    this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                    this.RW = this.Y.mul(new big_js_1.default(972.87)); /**  neu seit 2020  */
                    this.RW = this.RW.add(new big_js_1.default(1400));
                    this.ST = (this.RW.mul(this.Y)).round(0, 0 /* RoundDown */);
                }
                else {
                    if (this.X.cmp(new big_js_1.default(57052)) == -1) { /**  neu seit 2020  */
                        this.Y = (this.X.sub(new big_js_1.default(14532))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                        this.RW = this.Y.mul(new big_js_1.default(212.02)); /**  neu seit 2020  */
                        this.RW = this.RW.add(new big_js_1.default(2397));
                        this.RW = this.RW.mul(this.Y);
                        this.ST = (this.RW.add(new big_js_1.default(972.79))).round(0, 0 /* RoundDown */); /**  neu seit 2020  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(270501)) == -1) { /**  neu seit 2020  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8963.74))).round(0, 0 /* RoundDown */); /**  neu seit 2020  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(17078.74))).round(0, 0 /* RoundDown */); /**  neu seit 2020  */
                        }
                    }
                }
            }
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getAf = function () {
            return this.af;
        };
        /**
         * Setter for af.
         ...
         */
        Lohnsteuer2020Big.prototype.setAf = function (af) {
            this.af = af;
        };
        /**
         * Getter for AJAHR.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getAJAHR = function () {
            return this.AJAHR;
        };
        /**
         * Setter for AJAHR.
         ...
         */
        Lohnsteuer2020Big.prototype.setAJAHR = function (AJAHR) {
            this.AJAHR = AJAHR;
        };
        /**
         * Getter for ALTER1.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getALTER1 = function () {
            return this.ALTER1;
        };
        /**
         * Setter for ALTER1.
         ...
         */
        Lohnsteuer2020Big.prototype.setALTER1 = function (ALTER1) {
            this.ALTER1 = ALTER1;
        };
        /**
         * Getter for ENTSCH.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getENTSCH = function () {
            return this.ENTSCH;
        };
        /**
         * Setter for ENTSCH.
         ...
         */
        Lohnsteuer2020Big.prototype.setENTSCH = function (ENTSCH) {
            this.ENTSCH = ENTSCH;
        };
        /**
         * Getter for f.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getF = function () {
            return this.f;
        };
        /**
         * Setter for f.
         ...
         */
        Lohnsteuer2020Big.prototype.setF = function (f) {
            this.f = f;
        };
        /**
         * Getter for JFREIB.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getJFREIB = function () {
            return this.JFREIB;
        };
        /**
         * Setter for JFREIB.
         ...
         */
        Lohnsteuer2020Big.prototype.setJFREIB = function (JFREIB) {
            this.JFREIB = JFREIB;
        };
        /**
         * Getter for JHINZU.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getJHINZU = function () {
            return this.JHINZU;
        };
        /**
         * Setter for JHINZU.
         ...
         */
        Lohnsteuer2020Big.prototype.setJHINZU = function (JHINZU) {
            this.JHINZU = JHINZU;
        };
        /**
         * Getter for JRE4.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getJRE4 = function () {
            return this.JRE4;
        };
        /**
         * Setter for JRE4.
         ...
         */
        Lohnsteuer2020Big.prototype.setJRE4 = function (JRE4) {
            this.JRE4 = JRE4;
        };
        /**
         * Getter for JVBEZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getJVBEZ = function () {
            return this.JVBEZ;
        };
        /**
         * Setter for JVBEZ.
         ...
         */
        Lohnsteuer2020Big.prototype.setJVBEZ = function (JVBEZ) {
            this.JVBEZ = JVBEZ;
        };
        /**
         * Getter for KRV.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getKRV = function () {
            return this.KRV;
        };
        /**
         * Setter for KRV.
         ...
         */
        Lohnsteuer2020Big.prototype.setKRV = function (KRV) {
            this.KRV = KRV;
        };
        /**
         * Getter for KVZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getKVZ = function () {
            return this.KVZ;
        };
        /**
         * Setter for KVZ.
         ...
         */
        Lohnsteuer2020Big.prototype.setKVZ = function (KVZ) {
            this.KVZ = KVZ;
        };
        /**
         * Getter for LZZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getLZZ = function () {
            return this.LZZ;
        };
        /**
         * Setter for LZZ.
         ...
         */
        Lohnsteuer2020Big.prototype.setLZZ = function (LZZ) {
            this.LZZ = LZZ;
        };
        /**
         * Getter for LZZFREIB.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getLZZFREIB = function () {
         ...
         */
        Lohnsteuer2020Big.prototype.setLZZFREIB = function (LZZFREIB) {
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getLZZHINZU = function () {
         ...
         */
        Lohnsteuer2020Big.prototype.setLZZHINZU = function (LZZHINZU) {
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getPKPV = function () {
            return this.PKPV;
        };
        /**
         * Setter for PKPV.
         ...
         */
        Lohnsteuer2020Big.prototype.setPKPV = function (PKPV) {
            this.PKPV = PKPV;
        };
        /**
         * Getter for PKV.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getPKV = function () {
            return this.PKV;
        };
        /**
         * Setter for PKV.
         ...
         */
        Lohnsteuer2020Big.prototype.setPKV = function (PKV) {
            this.PKV = PKV;
        };
        /**
         * Getter for PVS.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getPVS = function () {
            return this.PVS;
        };
        /**
         * Setter for PVS.
         ...
         */
        Lohnsteuer2020Big.prototype.setPVS = function (PVS) {
            this.PVS = PVS;
        };
        /**
         * Getter for PVZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getPVZ = function () {
            return this.PVZ;
        };
        /**
         * Setter for PVZ.
         ...
         */
        Lohnsteuer2020Big.prototype.setPVZ = function (PVZ) {
            this.PVZ = PVZ;
        };
        /**
         * Getter for R.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getR = function () {
            return this.R;
        };
        /**
         * Setter for R.
         ...
         */
        Lohnsteuer2020Big.prototype.setR = function (R) {
            this.R = R;
        };
        /**
         * Getter for RE4.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getRE4 = function () {
            return this.RE4;
        };
        /**
         * Setter for RE4.
         ...
         */
        Lohnsteuer2020Big.prototype.setRE4 = function (RE4) {
            this.RE4 = RE4;
        };
        /**
         * Getter for SONSTB.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSONSTB = function () {
            return this.SONSTB;
        };
        /**
         * Setter for SONSTB.
         ...
         */
        Lohnsteuer2020Big.prototype.setSONSTB = function (SONSTB) {
            this.SONSTB = SONSTB;
        };
        /**
         * Getter for STERBE.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSTERBE = function () {
            return this.STERBE;
        };
        /**
         * Setter for STERBE.
         ...
         */
        Lohnsteuer2020Big.prototype.setSTERBE = function (STERBE) {
            this.STERBE = STERBE;
        };
        /**
         * Getter for STKL.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSTKL = function () {
            return this.STKL;
        };
        /**
         * Setter for STKL.
         ...
         */
        Lohnsteuer2020Big.prototype.setSTKL = function (STKL) {
            this.STKL = STKL;
        };
        /**
         * Getter for VBEZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVBEZ = function () {
            return this.VBEZ;
        };
        /**
         * Setter for VBEZ.
         ...
         */
        Lohnsteuer2020Big.prototype.setVBEZ = function (VBEZ) {
            this.VBEZ = VBEZ;
        };
        /**
         * Getter for VBEZM.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVBEZM = function () {
            return this.VBEZM;
        };
        /**
         * Setter for VBEZM.
         ...
         */
        Lohnsteuer2020Big.prototype.setVBEZM = function (VBEZM) {
            this.VBEZM = VBEZM;
        };
        /**
         * Getter for VBEZS.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVBEZS = function () {
            return this.VBEZS;
        };
        /**
         * Setter for VBEZS.
         ...
         */
        Lohnsteuer2020Big.prototype.setVBEZS = function (VBEZS) {
            this.VBEZS = VBEZS;
        };
        /**
         * Getter for VBS.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVBS = function () {
            return this.VBS;
        };
        /**
         * Setter for VBS.
         ...
         */
        Lohnsteuer2020Big.prototype.setVBS = function (VBS) {
            this.VBS = VBS;
        };
        /**
         * Getter for VJAHR.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVJAHR = function () {
            return this.VJAHR;
        };
        /**
         * Setter for VJAHR.
         ...
         */
        Lohnsteuer2020Big.prototype.setVJAHR = function (VJAHR) {
            this.VJAHR = VJAHR;
        };
        /**
         * Getter for VKAPA.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVKAPA = function () {
            return this.VKAPA;
        };
        /**
         * Setter for VKAPA.
         ...
         */
        Lohnsteuer2020Big.prototype.setVKAPA = function (VKAPA) {
            this.VKAPA = VKAPA;
        };
        /**
         * Getter for VMT.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVMT = function () {
            return this.VMT;
        };
        /**
         * Setter for VMT.
         ...
         */
        Lohnsteuer2020Big.prototype.setVMT = function (VMT) {
            this.VMT = VMT;
        };
        /**
         * Getter for ZKF.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getZKF = function () {
            return this.ZKF;
        };
        /**
         * Setter for ZKF.
         ...
         */
        Lohnsteuer2020Big.prototype.setZKF = function (ZKF) {
            this.ZKF = ZKF;
        };
        /**
         * Getter for ZMVB.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getZMVB = function () {
            return this.ZMVB;
        };
        /**
         * Setter for ZMVB.
         ...
         */
        Lohnsteuer2020Big.prototype.setZMVB = function (ZMVB) {
            this.ZMVB = ZMVB;
        };
        /**
         * Getter for JRE4ENT.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getJRE4ENT = function () {
            return this.JRE4ENT;
        };
        /**
         * Setter for JRE4ENT.
         ...
         */
        Lohnsteuer2020Big.prototype.setJRE4ENT = function (JRE4ENT) {
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSONSTENT = function () {
         ...
         */
        Lohnsteuer2020Big.prototype.setSONSTENT = function (SONSTENT) {
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getBK = function () {
            return this.BK;
        };
        /**
         * Getter for BKS.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getBKS = function () {
            return this.BKS;
        };
        /**
         * Getter for BKV.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getBKV = function () {
            return this.BKV;
        };
        /**
         * Getter for LSTLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getLSTLZZ = function () {
            return this.LSTLZZ;
        };
        /**
         * Getter for SOLZLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSOLZLZZ = function () {
            return this.SOLZLZZ;
        };
        /**
         * Getter for SOLZS.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSOLZS = function () {
            return this.SOLZS;
        };
        /**
         * Getter for SOLZV.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSOLZV = function () {
            return this.SOLZV;
        };
        /**
         * Getter for STS.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSTS = function () {
            return this.STS;
        };
        /**
         * Getter for STV.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getSTV = function () {
            return this.STV;
        };
        /**
         * Getter for VKVLZZ.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVKVLZZ = function () {
            return this.VKVLZZ;
        };
        /**
         * Getter for VKVSONST.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVKVSONST = function () {
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVFRB = function () {
            return this.VFRB;
        };
        /**
         * Getter for VFRBS1.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVFRBS1 = function () {
            return this.VFRBS1;
        };
        /**
         * Getter for VFRBS2.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getVFRBS2 = function () {
            return this.VFRBS2;
        };
        /**
         * Getter for WVFRB.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getWVFRB = function () {
            return this.WVFRB;
        };
        /**
         * Getter for WVFRBO.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getWVFRBO = function () {
            return this.WVFRBO;
        };
        /**
         * Getter for WVFRBM.
         ...
         * @return the value
         */
        Lohnsteuer2020Big.prototype.getWVFRBM = function () {
            return this.WVFRBM;
        };
        /**
         * Initialize all inputs values with zero.
         */
        Lohnsteuer2020Big.prototype.initInputs = function () {
         ...
         */
        Lohnsteuer2020Big.prototype.setBig = function (name, value) {
         ...
         */
        Lohnsteuer2020Big.prototype.setNumber = function (name, value) {
            if (this.hasOwnProperty(name)) {
                this[name] = value;
            }
            else {
         ...
         */
        Lohnsteuer2020Big.prototype.get = function (name) {
            if (this.hasOwnProperty(name)) {
                return this[name];
            }
            throw new Error("Unknown parameter " + name);
         ...
         */
        Lohnsteuer2020Big.prototype.getDirectory = function () {
         ...
         */
        Lohnsteuer2020Big.prototype.toType = function (name, value) {
            var info = Lohnsteuer2020Big.typeDirectory[name];
            if (!info) {
                throw new Error("Unknown parameter " + name);
            }

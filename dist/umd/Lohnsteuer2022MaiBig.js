            ...
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                ...
                if (this.X.cmp(new big_js_1.default(14927)) == -1) { /**  Geändert für 2022  */
                    ...
                    if (this.X.cmp(new big_js_1.default(58597)) == -1) { /**  Geändert für 2022  */
                        ...
                        this.ST = (this.RW.add(new big_js_1.default(869.32))).round(0, 0 /* RoundDown */); /**  Geändert für 2022.2  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(277826)) == -1) { /**  Geändert für 2022  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(9336.45))).round(0, 0 /* RoundDown */); /**  Geändert für 2022.2  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(17671.2))).round(0, 0 /* RoundDown */); /**  Geändert für 2022.2  */
                        }
                    }
                }
            }

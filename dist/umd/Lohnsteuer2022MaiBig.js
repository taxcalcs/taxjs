(function (factory) {
    ...
    exports.Lohnsteuer2022MaiBig = void 0;
    ...
    */
    var Lohnsteuer2022MaiBig = /** @class */ (function () {
        ...
        Lohnsteuer2022MaiBig.prototype.MPARA = function () {
            ...
            this.W1STKL5 = new big_js_1.default(11793); /**  2022.2  */
            this.W2STKL5 = new big_js_1.default(29298);
            this.W3STKL5 = new big_js_1.default(222260);
            this.GFB = new big_js_1.default(10347); /**  2022.2  */
        ...
        Lohnsteuer2022MaiBig.prototype.MZTABFB = function () {
            ...
            if (this.STKL < 6) {
                if (this.ZRE4.cmp(this.ZVBEZ) == 1) {
                    if (this.ZRE4.sub(this.ZVBEZ).cmp(new big_js_1.default(1200)) == -1) {
                        this.ANP = this.ANP.add(this.ZRE4).sub(this.ZVBEZ).round(0, big_js_1.default.roundUp);
                    }
                    else {
                        this.ANP = this.ANP.add(new big_js_1.default(1200));
                    }
                }
            }
            this.KZTAB = 1;
            if (this.STKL == 1) {
                ...
                this.KFB = (this.ZKF.mul(new big_js_1.default(8388))).round(0, big_js_1.default.roundDown); /**  Geändert für 2021  */
            }
            else {
                if (this.STKL == 2) {
                    ...
                    if (this.STKL == 3) {
                        ...
                        if (this.STKL == 4) {
                            this.SAP = new big_js_1.default(36);
                            this.KFB = (this.ZKF.mul(new big_js_1.default(4194))).round(0, big_js_1.default.roundDown); /**  Geändert für 2021  */
                        }
                        else {
                            if (this.STKL == 5) {
                                this.SAP = new big_js_1.default(36);
        ...
        Lohnsteuer2022MaiBig.prototype.UPTAB22 = function () {
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                ...
                if (this.X.cmp(new big_js_1.default(14927)) == -1) { /**  Geändert für 2022  */
                    ...
                    this.RW = this.Y.mul(new big_js_1.default(1088.67)); /**  Geändert für 2022.2  */
                    ...
                    if (this.X.cmp(new big_js_1.default(58597)) == -1) { /**  Geändert für 2022  */
                        this.Y = (this.X.sub(new big_js_1.default(14926))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown); /**  Geändert für 2022   */
                        ...
                        this.ST = (this.RW.add(new big_js_1.default(869.32))).round(0, big_js_1.default.roundDown); /**  Geändert für 2022.2  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(277826)) == -1) { /**  Geändert für 2022  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(9336.45))).round(0, big_js_1.default.roundDown); /**  Geändert für 2022.2  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(17671.2))).round(0, big_js_1.default.roundDown); /**  Geändert für 2022.2  */
                        }
                    }
                }
            }
    ...
    exports.Lohnsteuer2022MaiBig = Lohnsteuer2022MaiBig;
});

...
(function (factory) {
    ...
    exports.Lohnsteuer2022Big = void 0;
    ...
    */
            ...
            if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                ...
                if (this.X.cmp(new big_js_1.default(14927)) == -1) { /**  Geändert für 2022  */
                    ...
                    if (this.X.cmp(new big_js_1.default(58597)) == -1) { /**  Geändert für 2022  */
                        ...
                        this.ST = (this.RW.add(new big_js_1.default(938.24))).round(0, big_js_1.default.roundDown); /**  Geändert für 2022  */
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(277826)) == -1) { /**  Geändert für 2022  */
                            this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(9267.53))).round(0, big_js_1.default.roundDown); /**  Geändert für 2022  */
                        }
                        else {
                            this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(17602.28))).round(0, big_js_1.default.roundDown); /**  Geändert für 2022  */
                        }
                    }
                }
            }
    ...
    exports.Lohnsteuer2022Big = Lohnsteuer2022Big;
});

(function (factory) {
    ...
    */
    var Lohnsteuer2007Big = /** @class */ (function () {
         ...
         */
        Lohnsteuer2007Big.prototype.getBig = function (name) {
            switch (name) {
         ...
         * @param {String} name Variable name to get.
         */
        Lohnsteuer2007Big.prototype.getNumber = function (name) {
            switch (name) {
                default:
                    throw new Error("Unknown number parameter " + name);
            }
         ...
         * Get all input names.
         */
        Lohnsteuer2007Big.prototype.getInputs = function () {
            return [
         ...
         */
        Lohnsteuer2007Big.prototype.getOutputs = function () {
            return [

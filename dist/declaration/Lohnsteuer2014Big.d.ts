...
declare type Lohnsteuer2014BigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2014BigInNumberType = "af" | "AJAHR" | "ALTER1" | "f" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2014BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV" | "VKVLZZ" | "VKVSONST";
/**
...
*
*/
export declare class Lohnsteuer2014Big implements TaxJs<Lohnsteuer2014BigInBigType, Lohnsteuer2014BigInNumberType, Lohnsteuer2014BigOutType> {
    ...
    /**  Für den Lohnzahlungszeitraum berücksichtigte Beiträge des Arbeitnehmers zur
         ...
         VKVSONST  */
    private VKVLZZ; /**  Neu 2014 Ursprünglich INTERNAL definiert  */
    ...
    private VKVSONST; /** Neu 2014 Ursprünglich INTERNAL definiert  */
    /**   INTERNE FELDER   */
    ...
    /**  Neuer Wert  2014  */
    private readonly RENTBEMESSUNGSGR_OST;
    /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
    /**  Neuer Wert 2014  */
    private readonly RENTBEMESSUNGSGR_WEST;
     ...
     */
    setBig(name: Lohnsteuer2014BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2014BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2014BigInBigType | Lohnsteuer2014BigInNumberType | Lohnsteuer2014BigOutType): TaxJsValueType;

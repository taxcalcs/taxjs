...
declare type Lohnsteuer2009BigInBigType = "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "LZZFREIB" | "LZZHINZU" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF";
declare type Lohnsteuer2009BigInNumberType = "AJAHR" | "ALTER1" | "KRV" | "LZZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2009BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV";
/**
...
*
*/
export declare class Lohnsteuer2009Big implements TaxJs<Lohnsteuer2009BigInBigType, Lohnsteuer2009BigInNumberType, Lohnsteuer2009BigOutType> {
     ...
     */
    setBig(name: Lohnsteuer2009BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2009BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2009BigInBigType | Lohnsteuer2009BigInNumberType | Lohnsteuer2009BigOutType): TaxJsValueType;

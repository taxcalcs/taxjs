...
declare type Lohnsteuer2011NovemberBigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2011NovemberBigInNumberType = "af" | "AJAHR" | "ALTER1" | "f" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2011NovemberBigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV";
/**
...
*
*/
export declare class Lohnsteuer2011NovemberBig implements TaxJs<Lohnsteuer2011NovemberBigInBigType, Lohnsteuer2011NovemberBigInNumberType, Lohnsteuer2011NovemberBigOutType> {
    ...
    private RENTBEMESSUNGSGR_OST_2011;
    /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
    private RENTBEMESSUNGSGR_WEST;
     ...
     */
    setBig(name: Lohnsteuer2011NovemberBigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2011NovemberBigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2011NovemberBigInBigType | Lohnsteuer2011NovemberBigInNumberType | Lohnsteuer2011NovemberBigOutType): TaxJsValueType;

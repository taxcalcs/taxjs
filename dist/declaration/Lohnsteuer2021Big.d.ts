...
declare type Lohnsteuer2021BigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "KVZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2021BigInNumberType = "af" | "AJAHR" | "ALTER1" | "f" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2021BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV" | "VKVLZZ" | "VKVSONST" | "VFRB" | "VFRBS1" | "VFRBS2" | "WVFRB" | "WVFRBO" | "WVFRBM";
/**
...
*
*/
export declare class Lohnsteuer2021Big implements TaxJs<Lohnsteuer2021BigInBigType, Lohnsteuer2021BigInNumberType, Lohnsteuer2021BigOutType> {
     ...
     */
    setBig(name: Lohnsteuer2021BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2021BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2021BigInBigType | Lohnsteuer2021BigInNumberType | Lohnsteuer2021BigOutType): TaxJsValueType;

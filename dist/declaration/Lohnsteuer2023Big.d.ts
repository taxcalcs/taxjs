...
*
*/
export declare class Lohnsteuer2023Big implements TaxJs<Lohnsteuer2023BigInBigType, Lohnsteuer2023BigInNumberType, Lohnsteuer2023BigOutType> {
     ...
     */
    set(name: Lohnsteuer2023BigInBigType | Lohnsteuer2023BigInNumberType, value: TaxJsValueType): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2023BigInBigType | Lohnsteuer2023BigInNumberType | Lohnsteuer2023BigOutType): TaxJsValueType;

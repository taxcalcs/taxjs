...
declare type Lohnsteuer2012BigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2012BigInNumberType = "af" | "AJAHR" | "ALTER1" | "f" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2012BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV";
/**
...
*
*/
export declare class Lohnsteuer2012Big implements TaxJs<Lohnsteuer2012BigInBigType, Lohnsteuer2012BigInNumberType, Lohnsteuer2012BigOutType> {
    ...
    private readonly RENTBEMESSUNGSGR_OST_2012;
     ...
     */
    setBig(name: Lohnsteuer2012BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2012BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2012BigInBigType | Lohnsteuer2012BigInNumberType | Lohnsteuer2012BigOutType): TaxJsValueType;

...
declare type Lohnsteuer2018BigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "KVZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2018BigInNumberType = "af" | "AJAHR" | "ALTER1" | "f" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2018BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV" | "VKVLZZ" | "VKVSONST" | "VFRB" | "VFRBS1" | "VFRBS2" | "WVFRB" | "WVFRBO" | "WVFRBM";
/**
...
*
*/
export declare class Lohnsteuer2018Big implements TaxJs<Lohnsteuer2018BigInBigType, Lohnsteuer2018BigInNumberType, Lohnsteuer2018BigOutType> {
     ...
     */
    setBig(name: Lohnsteuer2018BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2018BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2018BigInBigType | Lohnsteuer2018BigInNumberType | Lohnsteuer2018BigOutType): TaxJsValueType;

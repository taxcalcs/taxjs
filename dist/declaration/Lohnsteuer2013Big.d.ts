...
declare type Lohnsteuer2013BigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2013BigInNumberType = "AF" | "AJAHR" | "ALTER1" | "F" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2013BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV";
/**
...
*
*/
export declare class Lohnsteuer2013Big implements TaxJs<Lohnsteuer2013BigInBigType, Lohnsteuer2013BigInNumberType, Lohnsteuer2013BigOutType> {
    ...
    /**  Neuer Wert  2013  */
    private readonly RENTBEMESSUNGSGR_OST_2013;
     ...
     */
    setBig(name: Lohnsteuer2013BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2013BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2013BigInBigType | Lohnsteuer2013BigInNumberType | Lohnsteuer2013BigOutType): TaxJsValueType;

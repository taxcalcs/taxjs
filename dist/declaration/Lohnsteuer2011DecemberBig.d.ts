...
declare type Lohnsteuer2011DecemberBigInBigType = "ENTSCH" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "LZZFREIB" | "LZZHINZU" | "PKPV" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "ZKF" | "JRE4ENT" | "SONSTENT";
declare type Lohnsteuer2011DecemberBigInNumberType = "af" | "AJAHR" | "ALTER1" | "f" | "KRV" | "LZZ" | "PKV" | "PVS" | "PVZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2011DecemberBigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV";
/**
...
*
*/
export declare class Lohnsteuer2011DecemberBig implements TaxJs<Lohnsteuer2011DecemberBigInBigType, Lohnsteuer2011DecemberBigInNumberType, Lohnsteuer2011DecemberBigOutType> {
     ...
     */
    setBig(name: Lohnsteuer2011DecemberBigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2011DecemberBigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2011DecemberBigInBigType | Lohnsteuer2011DecemberBigInNumberType | Lohnsteuer2011DecemberBigOutType): TaxJsValueType;

...
declare type Lohnsteuer2007BigInBigType = "HINZUR" | "JFREIB" | "JHINZU" | "JRE4" | "JVBEZ" | "RE4" | "SONSTB" | "STERBE" | "VBEZ" | "VBEZM" | "VBEZS" | "VBS" | "VKAPA" | "VMT" | "WFUNDF" | "ZKF";
declare type Lohnsteuer2007BigInNumberType = "AJAHR" | "ALTER1" | "KRV" | "LZZ" | "R" | "STKL" | "VJAHR" | "ZMVB";
declare type Lohnsteuer2007BigOutType = "BK" | "BKS" | "BKV" | "LSTLZZ" | "SOLZLZZ" | "SOLZS" | "SOLZV" | "STS" | "STV";
/**
...
*
*/
export declare class Lohnsteuer2007Big implements TaxJs<Lohnsteuer2007BigInBigType, Lohnsteuer2007BigInNumberType, Lohnsteuer2007BigOutType> {
     ...
     */
    setBig(name: Lohnsteuer2007BigInBigType, value: Big): void;
    /**
     ...
     */
    setNumber(name: Lohnsteuer2007BigInNumberType, value: number): void;
    /**
     * Getter for all output parameters. You get a value of type "number or "Big".
     *
     * @param {string} name Variable name to get.
     */
    get(name: Lohnsteuer2007BigInBigType | Lohnsteuer2007BigInNumberType | Lohnsteuer2007BigOutType): TaxJsValueType;

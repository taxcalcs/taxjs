                ...
                */
                ...
                Lohnsteuer2013Big.prototype.UPEVP = function () {
                    if (this.KRV > 1) {
                        ...
                        /**  Neuer Wert 2013  */
                        this.VSP1 = (this.ZRE4VP.mul(new big_js_1.default(0.52))).round(2, big_js_1.default.roundDown);
                ...
                Lohnsteuer2013Big.prototype.MST5_6 = function () {
                    ...
                    if (this.ZZX.cmp(new big_js_1.default(26441)) == 1) {
                        ...
                        if (this.ZZX.cmp(new big_js_1.default(9550)) == 1) {
                            ...
                            this.UP5_6();
                            this.HOCH = (this.ST.add((this.ZZX.sub(new big_js_1.default(9550))).mul(new big_js_1.default(0.42)))).round(0, big_js_1.default.roundDown);
                ...
                Lohnsteuer2013Big.prototype.UPTAB13 = function () {
                    if (this.X.cmp(new big_js_1.default(8131)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(13470)) == -1) {
                            this.Y = (this.X.sub(new big_js_1.default(8130))).div(new big_js_1.default(10000)).round(6, big_js_1.default.roundDown);
                            ...
                            if (this.X.cmp(new big_js_1.default(52882)) == -1) {
                                ...
                                this.ST = (this.RW.add(new big_js_1.default(1014))).round(0, big_js_1.default.roundDown);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(250731)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8196))).round(0, big_js_1.default.roundDown);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(15718))).round(0, big_js_1.default.roundDown);
                                }
                            }
                        }
                    }

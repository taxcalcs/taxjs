System.register(["big.js"], function (exports_1, context_1) {
    "use strict";
    var big_js_1, Lohnsteuer2009Big;
    ...
    return {
        ...
        execute: function () {
            ...
            *
            */
            Lohnsteuer2009Big = /** @class */ (function () {
                ...
                Lohnsteuer2009Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(6024))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(3012))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    this.KFB = this.Z_0;
                                }
                ...
                Lohnsteuer2009Big.prototype.UPEVP = function () {
                    ...
                    if (this.KRV > 0) {
                        ...
                        this.VSP1 = (this.ZRE4VP.mul(new big_js_1.default(0.36))).round(2, 0 /* RoundDown */);
                ...
                Lohnsteuer2009Big.prototype.MST5_6 = function () {
                    ...
                    if (this.ZZX.cmp(new big_js_1.default(26276)) == 1) {
                        ...
                        if (this.ZZX.cmp(new big_js_1.default(200320)) == 1) {
                            this.ST = (this.ST.add((new big_js_1.default(200320).sub(new big_js_1.default(26276))).mul(new big_js_1.default(0.42)))).round(0, 0 /* RoundDown */);
                            this.ST = (this.ST.add((this.ZZX.sub(new big_js_1.default(200320))).mul(new big_js_1.default(0.45)))).round(0, 0 /* RoundDown */);
                        }
                        else {
                            this.ST = (this.ST.add((this.ZZX.sub(new big_js_1.default(26276))).mul(new big_js_1.default(0.42)))).round(0, 0 /* RoundDown */);
                        }
                    }
                    else {
                        this.ZX = this.ZZX;
                        ...
                        if (this.ZZX.cmp(new big_js_1.default(9225)) == 1) {
                            ...
                            this.UP5_6();
                            this.HOCH = (this.ST.add((this.ZZX.sub(new big_js_1.default(9225))).mul(new big_js_1.default(0.42)))).round(0, 0 /* RoundDown */);
                ...
                Lohnsteuer2009Big.prototype.UPTAB09 = function () {
                    if (this.X.cmp(new big_js_1.default(7835)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(13140)) == -1) {
                            this.Y = (this.X.sub(new big_js_1.default(7834))).div(new big_js_1.default(10000)).round(6, 0 /* RoundDown */);
                            ...
                            if (this.X.cmp(new big_js_1.default(52552)) == -1) {
                                this.Y = (this.X.sub(new big_js_1.default(13139))).div(new big_js_1.default(10000)).round(6, 0 /* RoundDown */);
                                this.RW = this.Y.mul(new big_js_1.default(228.74));
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(1007))).round(0, 0 /* RoundDown */);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(250401)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8064))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(15576))).round(0, 0 /* RoundDown */);
                                }
                            }
                        }
                    }
                 ...
                 */
                Lohnsteuer2009Big.prototype.setBig = function (name, value) {
                    switch (name) {
                        case 'JFREIB':
                            this.JFREIB = value;
                            break;
                 ...
                 * @param {Big} value Value to set.
                 */
                Lohnsteuer2009Big.prototype.setNumber = function (name, value) {
                    switch (name) {
                        case 'AJAHR':
                            this.AJAHR = value;
                            break;
                 ...
                 */
                Lohnsteuer2009Big.prototype.getBig = function (name) {
                    switch (name) {
                 ...
                 * @param {String} name Variable name to get.
                 */
                Lohnsteuer2009Big.prototype.getNumber = function (name) {
                    switch (name) {
                        default:
                            throw new Error("Unknown number parameter " + name);
                    }
                 ...
                 * Get all input names.
                 */
                Lohnsteuer2009Big.prototype.getInputs = function () {
                    return [
                 ...
                 */
                Lohnsteuer2009Big.prototype.getOutputs = function () {
                    return [
            ...
            exports_1("Lohnsteuer2009Big", Lohnsteuer2009Big);
        }
    };
});

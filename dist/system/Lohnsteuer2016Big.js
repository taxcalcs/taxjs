            ...
            Lohnsteuer2016Big = /** @class */ (function () {
                ...
                */
                ...
                Lohnsteuer2016Big.prototype.MBERECH = function () {
                    ...
                    this.VFRB = ((this.ANP.add(this.FVB.add(this.FVBZ))).mul(this.ZAHL100)).round(0, 0 /* RoundDown */); /**  Neu 2016  */
                    this.MLSTJAHR();
                    /**  Anfang Neu 2016  */
                ...
                Lohnsteuer2016Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(7248))).round(0, 0 /* RoundDown */); /**  Neu 2016  */
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(3624))).round(0, 0 /* RoundDown */); /**  Neu 2016  */
                                }
                                else {
                                    if (this.STKL == 5) {
                                        this.SAP = new big_js_1.default(36);
                    ...
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(13670)) == -1) {
                            ...
                            if (this.X.cmp(new big_js_1.default(53666)) == -1) {
                                this.Y = (this.X.sub(new big_js_1.default(13669))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                                this.RW = this.Y.mul(new big_js_1.default(225.40));
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(952.48))).round(0, 0 /* RoundDown */);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(254447)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8394.14))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(16027.52))).round(0, 0 /* RoundDown */);
                                }
                            }
                        }
                    }
                 ...
                 */
                Lohnsteuer2016Big.prototype.setBig = function (name, value) {
                 ...
                 */
                Lohnsteuer2016Big.prototype.setNumber = function (name, value) {
                    if (this.hasOwnProperty(name)) {
                        this[name] = value;
                    }
                    else {

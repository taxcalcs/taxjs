                ...
                */
                ...
                Lohnsteuer2017Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(7356))).round(0, 0 /* RoundDown */); /**  Neu 2017  */
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(3678))).round(0, 0 /* RoundDown */); /**  Neu 2017  */
                                }
                                else {
                                    if (this.STKL == 5) {
                                        this.SAP = new big_js_1.default(36);
                    ...
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(13770)) == -1) {
                            ...
                            if (this.X.cmp(new big_js_1.default(54058)) == -1) {
                                this.Y = (this.X.sub(new big_js_1.default(13769))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                                this.RW = this.Y.mul(new big_js_1.default(223.76));
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(939.57))).round(0, 0 /* RoundDown */);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(256304)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8475.44))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(16164.53))).round(0, 0 /* RoundDown */);
                                }
                            }
                        }
                    }
                 ...
                 */
                Lohnsteuer2017Big.prototype.setBig = function (name, value) {
                 ...
                 */
                Lohnsteuer2017Big.prototype.setNumber = function (name, value) {
                    if (this.hasOwnProperty(name)) {
                        this[name] = value;
                    }
                    else {

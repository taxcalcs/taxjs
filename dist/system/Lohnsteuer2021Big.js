System.register(["big.js"], function (exports_1, context_1) {
    "use strict";
    var big_js_1, Lohnsteuer2021Big;
    ...
    return {
        ...
        execute: function () {
            Lohnsteuer2021Big = /** @class */ (function () {
                /**
                    ...
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(14754)) == -1) { /**  Geändert für 2021  */
                            ...
                            if (this.X.cmp(new big_js_1.default(57919)) == -1) { /**  Geändert für 2021  */
                                this.Y = (this.X.sub(new big_js_1.default(14753))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown); /**  Geändert für 2021   */
                                ...
                                this.ST = (this.RW.add(new big_js_1.default(950.96))).round(0, big_js_1.default.roundDown); /**  Geändert für 2021  */
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(274613)) == -1) { /**  Geändert für 2021  */
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(9136.63))).round(0, big_js_1.default.roundDown); /**  Geändert für 2021  */
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(17374.99))).round(0, big_js_1.default.roundDown); /**  Geändert für 2021  */
                                }
                            }
                        }
                    }
            ...
            exports_1("Lohnsteuer2021Big", Lohnsteuer2021Big);
        }
    };
});

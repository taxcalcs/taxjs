                ...
                */
                ...
                Lohnsteuer2019Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(7620))).round(0, 0 /* RoundDown */); /**  Neu 2019  */
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(3810))).round(0, 0 /* RoundDown */); /**  Neu 2019  */
                                }
                                else {
                                    if (this.STKL == 5) {
                                        this.SAP = new big_js_1.default(36);
                    ...
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(14255)) == -1) {
                            ...
                            if (this.X.cmp(new big_js_1.default(55961)) == -1) {
                                this.Y = (this.X.sub(new big_js_1.default(14254))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                                this.RW = this.Y.mul(new big_js_1.default(216.16));
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(965.58))).round(0, 0 /* RoundDown */);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(265327)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8780.9))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(16740.68))).round(0, 0 /* RoundDown */);
                                }
                            }
                        }
                    }
                 ...
                 */
                Lohnsteuer2019Big.prototype.setBig = function (name, value) {
                 ...
                 */
                Lohnsteuer2019Big.prototype.setNumber = function (name, value) {
                    if (this.hasOwnProperty(name)) {
                        this[name] = value;
                    }
                    else {

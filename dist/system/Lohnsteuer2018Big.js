System.register(["big.js"], function (exports_1, context_1) {
    "use strict";
    var big_js_1, Lohnsteuer2018Big;
    ...
    return {
        ...
        execute: function () {
            Lohnsteuer2018Big = /** @class */ (function () {
                /**
                ...
                */
                ...
                Lohnsteuer2018Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(7428))).round(0, 0 /* RoundDown */);
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(3714))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    if (this.STKL == 5) {
                                        this.SAP = new big_js_1.default(36);
                ...
                Lohnsteuer2018Big.prototype.MST5_6 = function () {
                    ...
                    if (this.ZZX.cmp(this.W2STKL5) == 1) {
                        ...
                        if (this.ZZX.cmp(this.W1STKL5) == 1) {
                            ...
                            this.UP5_6();
                            this.HOCH = (this.ST.add((this.ZZX.sub(this.W1STKL5)).mul(new big_js_1.default(0.42)))).round(0, 0 /* RoundDown */);
                    ...
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(13997)) == -1) {
                            ...
                            if (this.X.cmp(new big_js_1.default(54950)) == -1) {
                                this.Y = (this.X.sub(new big_js_1.default(13996))).div(this.ZAHL10000).round(6, 0 /* RoundDown */);
                                this.RW = this.Y.mul(new big_js_1.default(220.13));
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(948.49))).round(0, 0 /* RoundDown */);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(260533)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(8621.75))).round(0, 0 /* RoundDown */);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(16437.7))).round(0, 0 /* RoundDown */);
                                }
                            }
                        }
                    }
            ...
            exports_1("Lohnsteuer2018Big", Lohnsteuer2018Big);
        }
    };
});

                ...
                */
                ...
                Lohnsteuer2014Big.prototype.UPEVP = function () {
                    if (this.KRV > 1) {
                        ...
                        /**  Neuer Wert 2014  */
                        this.VSP1 = (this.ZRE4VP.mul(new big_js_1.default(0.56))).round(2, big_js_1.default.roundDown);
                        this.VSP1 = (this.VSP1.mul(new big_js_1.default(0.0945))).round(2, big_js_1.default.roundDown);
                    }
                ...
                Lohnsteuer2014Big.prototype.MST5_6 = function () {
                    ...
                    if (this.ZZX.cmp(new big_js_1.default(26441)) == 1) {
                        ...
                        if (this.ZZX.cmp(new big_js_1.default(9763)) == 1) { /**  Neuer Wert 2014  */
                            ...
                            this.UP5_6();
                            this.HOCH = (this.ST.add((this.ZZX.sub(new big_js_1.default(9763))).mul(new big_js_1.default(0.42)))).round(0, big_js_1.default.roundDown); /**  Neuer Wert 2014  */
                ...
                Lohnsteuer2014Big.prototype.UPTAB14 = function () {
                    if (this.X.cmp(new big_js_1.default(8355)) == -1) { /**  Neuer Wert 2014  */
                        ...
                        if (this.X.cmp(new big_js_1.default(13470)) == -1) {
                            this.Y = (this.X.sub(new big_js_1.default(8354))).div(new big_js_1.default(10000)).round(6, big_js_1.default.roundDown); /**  Neuer Wert 2014  */
                            ...
                            if (this.X.cmp(new big_js_1.default(52882)) == -1) {
                                ...
                                this.ST = (this.RW.add(new big_js_1.default(971))).round(0, big_js_1.default.roundDown); /**  Neuer Wert 2014  */
                            }
                            else {
